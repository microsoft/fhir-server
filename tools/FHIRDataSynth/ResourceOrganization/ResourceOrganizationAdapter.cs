...
namespace ResourceProcessorNamespace
{
    ...
    class OrganizationAdapter : ResourceAdapter<Organization.Rootobject, OrganizationSibling>
    {
        ...
        public override bool ValidateResourceRefsAndSelect(ResourceGroupProcessor processor, Organization.Rootobject json, out bool select) { select = true; return true; }
    }
}
