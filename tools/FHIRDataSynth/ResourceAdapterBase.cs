...
namespace ResourceProcessorNamespace
{
    ...
    struct ResourceSiblingsContainer<T> where T : struct
    {
        private T[] siblings;
        ...
        /*public ref T Get_OLD(int siblingNumber)
        {
            return ref siblings[siblingNumber % siblings.Length];
        }*/
        ...
        where U : struct
    {
        ...
        public void Initialize(ResourceGroupProcessor processor, JsonSerializerOptions options) { this.processor = processor; this.options = options; }
