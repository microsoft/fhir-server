...
{
    public class CosmosDbStorageTests : FhirStorageTestsBase, IClassFixture<IntegrationTestCosmosFhirDataStore>
    {
        public CosmosDbStorageTests(IntegrationTestCosmosFhirDataStore dataStore)
            : base(dataStore)
        {
        }
