...
namespace Microsoft.Health.Fhir.Tests.E2E.Rest
{
    public partial class UpdateTests : IClassFixture<HttpIntegrationTestFixture>
    {
        ...
        public async Task WhenUpdatingAResourceWithInvalidETagHeader_GivenR5Server_TheServerShouldReturnAPreconditionFailedResponse(string versionId)
        {
        ...
        [Fact]
        [Trait(Traits.Priority, Priority.One)]
        public async Task WhenUpdatingAResourceWithIncorrectETagHeader_GivenR5Server_TheServerShouldReturnAPreconditionFailedResponse()
        {
            Observation createdResource = await Client.CreateAsync(Samples.GetDefaultObservation().ToPoco<Observation>());
