...
namespace Microsoft.Health.Fhir.Tests.Integration.Persistence
{
    ...
    {
        private const string LocalConnectionString = "Server=tcp:tongwu-task.database.windows.net,1433;Initial Catalog=tongu0412;Persist Security Info=False;User ID=tongwu;Password=!1qaz@2wsx#3edc;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
