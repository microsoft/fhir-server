...
namespace Microsoft.Health.Fhir.Tests.Integration.Persistence
{
    ...
    public class SqlQueueClientTests : IClassFixture<SqlServerFhirStorageTestsFixture>
    {
        ...
        public async Task GivenNewJobs_WhenEnqueueJobs_ThenCreatedJobsShouldBeReturned()
        {
            ...
            SqlQueueClient sqlQueueClient = new SqlQueueClient(_fixture.SqlConnectionWrapperFactory, _schemaInformation, _fixture.SqlRetryService, _logger);
        ...
        public async Task GivenRunningJobCancelled_WhenHeartbeat_ThenCancelRequestedShouldBeReturned()
        {
            ...
            var client = new SqlQueueClient(_fixture.SqlConnectionWrapperFactory, _schemaInformation, _fixture.SqlRetryService, _logger);
        ...
        public async Task GivenGroupJobs_WhenCancelJobsById_ThenOnlySingleJobShouldBeCancelled()
        {
            ...
            var sqlQueueClient = new SqlQueueClient(_fixture.SqlConnectionWrapperFactory, _schemaInformation, _fixture.SqlRetryService, _logger);
        ...
        public async Task ExecuteWithHeartbeats()
        {
            ...
            var client = new SqlQueueClient(_fixture.SqlConnectionWrapperFactory, _schemaInformation, _fixture.SqlRetryService, XUnitLogger<SqlQueueClient>.Create(_testOutputHelper));
            await client.EnqueueAsync(queueType, new[] { "job" }, null, false, false, CancellationToken.None);
