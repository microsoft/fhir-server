    ...
    public class SqlServerSetMergeTests : IClassFixture<SqlServerFhirStorageTestsFixture>
    {
        ...
        public async Task GivenSetOfResources_MergeAndGet()
        {
            ...
            var mergeResults = await _store.MergeAsync(
                ...
                {
                    new ResourceWrapperOperation(patientWrapper, true, true, null, false, false, false, bundleResourceContext: null),
                    new ResourceWrapperOperation(observationWrapper, true, true, null, false, false, false, bundleResourceContext: null),
                },
                default);
