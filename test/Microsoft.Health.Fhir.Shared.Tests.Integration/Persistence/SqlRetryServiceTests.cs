...
namespace Microsoft.Health.Fhir.Tests.Integration.Persistence
{
    ...
    public class SqlRetryServiceTests : IClassFixture<SqlServerFhirStorageTestsFixture>
    {
        ...
        {
            await SingleRetryTest(SqlDefaultErrorNumber, CreateTestStoredProcedureWithSingleFatalError, false, 10);
        }
...
END
        ...
        private async Task<List<long>> SqlCommandFuncWithRetries(SqlCommand sqlCommand, CancellationToken cancellationToken)
        {
            sqlCommand.CommandText = "dbo.TestStoredProcedure";
            ...
            {
                results.Add(sqlDataReader.GetInt64(0));
            }
