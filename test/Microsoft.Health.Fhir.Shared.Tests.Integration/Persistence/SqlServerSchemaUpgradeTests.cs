        ...
        private async Task<string> CompareDatabaseSchemas(string databaseName1, string databaseName2)
        {
            ...
            foreach (SchemaDifference schemaDifference in remainingDifferences)
            {
                ...
                else
                {
                    ...
                    var objectsToSkip = new[] { "DisableIndexes", "GetResourceVersions", "CleanupEventLog", "InitDefrag", "EnqueueJobs", "GetResourcesByTypeAndSurrogateIdRange", "GetResourceSurrogateIdRanges", "GetCommandsForRebuildIndexes", "GetIndexCommands", "SwitchPartitionsIn", "SwitchPartitionsOut" };
