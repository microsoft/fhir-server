        ...
        private async Task<string> CompareDatabaseSchemas(string databaseName1, string databaseName2)
        {
            ...
            foreach (SchemaDifference schemaDifference in remainingDifferences)
            {
                ...
                else
                {
                    ...
                    var objectsToSkip = new[] { "GetResourceSearchParamStats", "MergeResourcesAdvanceTransactionVisibility", "DequeueJob", "DisableIndexes", "GetResourceVersions", "CleanupEventLog", "InitDefrag", "EnqueueJobs", "GetResourceSurrogateIdRanges", "GetCommandsForRebuildIndexes", "GetIndexCommands", "SwitchPartitionsIn", "SwitchPartitionsOut" }.ToList();
