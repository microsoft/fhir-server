...
namespace Microsoft.Health.Fhir.Tests.Integration.Persistence
{
    ...
    public class CosmosDbExportTests : IClassFixture<CosmosDbFhirStorageTestsFixture>
    {
        ...
        private readonly IFhirStorageTestHelper _cosmosDbFhirStorageTestHelper;
        ...
        public CosmosDbExportTests(CosmosDbFhirStorageTestsFixture fixture, ITestOutputHelper testOutputHelper, )
        {
            ...
            _queueClient = Substitute.ForPartsOf<CosmosQueueClient>(() => _fixture.Container.CreateMockScope(), _fixture.GetService<ICosmosQueryFactory>(), _fixture.GetService<ICosmosDbDistributedLockFactory>());
# _cosmosDbFhirStorageTestHelper = 
        }
