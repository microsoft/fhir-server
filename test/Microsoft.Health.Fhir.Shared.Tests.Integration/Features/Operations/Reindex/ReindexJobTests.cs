...
namespace Microsoft.Health.Fhir.Tests.Integration.Features.Operations.Reindex
{
    ...
    public class ReindexJobTests : IClassFixture<FhirStorageTestsFixture>, IAsyncLifetime
    {
        ...
        public ReindexJobTests(FhirStorageTestsFixture fixture)
        {
            ...
            var searchOptionsFactory = new SearchOptionsFactory(expressionParser, () => _searchParameterDefinitionManager, coreOptions, NullLogger<SearchOptionsFactory>.Instance);
        ...
        {
            var searchParam = _supportedSearchParameterDefinitionManager.GetSearchParameter(new Uri("http://hl7.org/fhir/SearchParameter/EffectEvidenceSynthesis-context"));
