    ...
    public class FhirClient
    {
        ...
        private async Task SetupAuthenticationAsync()
        {
            ...
            if (SecuritySettings.SecurityEnabled)
            {
                ...
                {
                    new KeyValuePair<string, string>("client_id", TestApplications.MyClient.ClientId),
                    new KeyValuePair<string, string>("client_secret", TestApplications.MyClient.ClientSecret),
                    new KeyValuePair<string, string>("grant_type", TestApplications.MyClient.GrantType),
