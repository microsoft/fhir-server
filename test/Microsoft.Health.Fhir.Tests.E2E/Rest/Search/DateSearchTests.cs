...
namespace Microsoft.Health.Fhir.Tests.E2E.Rest.Search
{
    public class DateSearchTests : SearchTestsBase<DateSearchTestFixture>
    {
        ...
        [Theory]
        [InlineData("1980", 1, 2, 3, 4, 5, 6)] // Any dates with start time greater than or equal to 1980-01-01T00:00:00.0000000 and end time less than or equal to 1980-12-31T23:59:59.9999999.
        ...
        [InlineData("1980-05", 2, 3, 4, 5, 6)] // Any dates with start time greater than or equal to 1980-05-01T00:00:00.0000000 and end time less than or equal to 1980-05-31T23:59:59.9999999.
        ...
        [InlineData("1980-05-11", 3, 4, 5, 6)] // Any dates with start time greater than or equal to 1980-05-11T00:00:00.0000000 and end time less than or equal to 1980-05-11T23:59:59.9999999.
        [InlineData("1980-05-11T16:32", 4, 5, 6)] // Any dates with start time greater than or equal to 1980-05-11T16:32:00.0000000 and end time less than or equal to 1980-05-11T16:32:59.9999999.
        [InlineData("1980-05-11T16:32:15", 5, 6)] // Any dates with start time greater than or equal to 1980-05-11T16:32:15.0000000 and end time less than or equal to 1980-05-11T16:32:15.9999999.
        [InlineData("1980-05-11T16:32:15.500", 6)] // Any dates with start time greater than or equal to 1980-05-11T16:32:30.5000000 and end time less than or equal to 1980-05-11T16:32:30.50000000.
        [InlineData("1980-05-11T16:32:15.5000000", 6)] // Any dates with start time greater than or equal to 1980-05-11T16:32:30.5000000 and end time less than or equal to 1980-05-11T16:32:30.50000000.
        ...
        [InlineData("ne1980", 0, 7)] // Any dates with start time less than 1980-01-01T00:00:00.0000000 or end time greater than 1980-12-31T23:59:59.9999999.
        ...
        [InlineData("ne1980-05", 0, 1, 7)] // Any dates with start time less than 1980-05-01T00:00:00.0000000 or end time greater than 1980-05-31T23:59:59.9999999.
        [InlineData("ne1980-05-10", 0, 1, 2, 3, 4, 5, 6, 7)] // Any dates with start time less than 1980-05-10T00:00:00.0000000 or end time greater than 1980-05-10T23:59:59.9999999.
        [InlineData("ne1980-05-11", 0, 1, 2, 7)] // Any dates with start time less than 1980-05-11T00:00:00.0000000 or end time greater than 1980-05-11T23:59:59.9999999.
        [InlineData("ne1980-05-11T16:32", 0, 1, 2, 3, 7)] // Any dates with start time less than 1980-05-11T16:32:00.0000000 or end time greater than 1980-05-11T16:32:59.9999999.
        [InlineData("ne1980-05-11T16:32:15", 0, 1, 2, 3, 4, 7)] // Any dates with start time less than 1980-05-11T16:32:15.0000000 or end time greater than 1980-05-11T16:32:15.9999999.
        [InlineData("ne1980-05-11T16:32:15.500", 0, 1, 2, 3, 4, 5, 7)] // Any dates with start time less than 1980-05-11T16:32:15.5000000 or end time greater than 1980-05-11T16:32:15.5000000.
        ...
        [InlineData("gt1980-05", 1, 7)] // Only dates with end time later than 1980-05-31T23:59:59.9999999 would match.
        [InlineData("gt1980-05-11", 1, 2, 7)] // Only dates with end time later than 1980-05-11T23:59:59.9999999 would match.
        [InlineData("gt1980-05-11T16:32", 1, 2, 3, 7)] // Only dates with end time later than 1980-05-11T16:32:59.9999999 would match.
        [InlineData("gt1980-05-11T16:32:14", 1, 2, 3, 4, 5, 6, 7)] // Only dates with end time later than 1980-05-11T16:32:14.9999999 would match.
        [InlineData("gt1980-05-11T16:32:15", 1, 2, 3, 4, 7)] // Only dates with end time later than 1980-05-11T16:32:15.9999999 would match.
        [InlineData("gt1980-05-11T16:32:15.4999999", 1, 2, 3, 4, 5, 6, 7)] // Only dates with end time later than 1980-05-11T16:32:15.4999999 would match.
        [InlineData("gt1980-05-11T16:32:15.500", 1, 2, 3, 4, 5, 7)] // Only dates with end time later than 1980-05-11T16:32:15.5000000 would match.
        [InlineData("gt1980-05-11T16:32:15.5000000", 1, 2, 3, 4, 5, 7)] // Only dates with end time later than 1980-05-11T16:32:15.5000000 would match.
        [InlineData("gt1980-05-11T16:32:15.5000001", 1, 2, 3, 4, 5, 7)] // Only dates with end time later than 1980-05-11T16:32:15.5000001 would match.
        [InlineData("gt1980-05-11T16:32:16", 1, 2, 3, 4, 7)] // Only dates with end time later than 1980-05-11T16:32:16.9999999 would match.
        [InlineData("gt1980-05-11T16:33", 1, 2, 3, 7)] // Only dates with end time later than 1980-05-11T16:33:99.9999999 would match.
        ...
        [InlineData("ge1980-05", 1, 2, 3, 4, 5, 6, 7)] // Only dates with end time later than or equal to 1980-05-01T00:00:00.0000000 would match.
        [InlineData("ge1980-05-11", 1, 2, 3, 4, 5, 6, 7)] // Only dates with end time later than or equal to 1980-05-11T00:00:00.0000000 would match.
        [InlineData("ge1980-05-11T16:32", 1, 2, 3, 4, 5, 6, 7)] // Only dates with end time later than or equal to 1980-05-11T16:32:00.0000000 would match.
        [InlineData("ge1980-05-11T16:32:14", 1, 2, 3, 4, 5, 6, 7)] // Only dates with end time later than or equal to 1980-05-11T16:32:14.0000000 would match.
        [InlineData("ge1980-05-11T16:32:15", 1, 2, 3, 4, 5, 6, 7)] // Only dates with end time later than or equal to 1980-05-11T16:32:15.0000000 would match.
        [InlineData("ge1980-05-11T16:32:15.4999999", 1, 2, 3, 4, 5, 6, 7)] // Only dates with end time later than or equal to 1980-05-11T16:32:15.4999999 would match.
        [InlineData("ge1980-05-11T16:32:15.500", 1, 2, 3, 4, 5, 6, 7)] // Only dates with end time later than or equal to 1980-05-11T16:32:15.5000000 would match.
        [InlineData("ge1980-05-11T16:32:15.5000000", 1, 2, 3, 4, 5, 6, 7)] // Only dates with end time later than or equal to 1980-05-11T16:32:15.5000000 would match.
        [InlineData("ge1980-05-11T16:32:15.5000001", 1, 2, 3, 4, 5, 7)] // Only dates with end time later than or equal to 1980-05-11T16:32:15.5000001 would match.
        [InlineData("ge1980-05-11T16:32:16", 1, 2, 3, 4, 7)] // Only dates with end time later than 1980-05-11T16:32:16.0000000 would match.
        [InlineData("ge1980-05-11T16:33", 1, 2, 3, 7)] // Only dates with end time later than or equal to 1980-05-11T16:33:00.0000000 would match.
        [InlineData("ge1980-05-12", 1, 2, 7)] // Only dates with end time later than or equal to 1980-05-12T00:00:00.0000000 would match.
        [InlineData("ge1980-06", 1, 7)] // Only dates with end time later than or equal to 1980-06-01T00:00:00.0000000 would match.
        [InlineData("ge1981-01-01T00:00:00.0000001", 7)] // Only dates with end time later than or equal to 1981-01-01T00:00:00.0000001 would match.
        [InlineData("sa1980", 7)] // Only dates with start time later than 1981-12-31T23:59:59.9999999 would match.
        [InlineData("sa1980-04", 2, 3, 4, 5, 6, 7)] // Only dates with start time later than 1980-04-30T23:59:59.9999999 would match.
        [InlineData("sa1980-05", 7)] // Only dates with start time later than 1980-05-31T23:59:59.9999999 would match.
        [InlineData("sa1980-05-10", 3, 4, 5, 6, 7)] // Only dates with start time later than 1980-05-10T23:59:59.9999999 would match.
        [InlineData("sa1980-05-11", 7)] // Only dates with start time later than 1980-05-11T23:59:59.9999999 would match.
        [InlineData("sa1980-05-11T16:32", 7)] // Only dates with start time later than 1980-05-11T16:32:59.9999999 would match.
        [InlineData("sa1980-05-11T16:32:14", 5, 6, 7)] // Only dates with start time later than 1980-05-11T16:32:14.9999999 would match.
        [InlineData("sa1980-05-11T16:32:15", 7)] // Only dates with start time later than 1980-05-11T16:32:15.9999999 would match.
        [InlineData("sa1980-05-11T16:32:15.4999999", 6, 7)] // Only dates with start time later than 1980-05-11T16:32:15.49999999 would match.
        [InlineData("sa1980-05-11T16:32:15.500", 7)] // Only dates with start time later than 1980-05-11T16:32:15.5000000 would match.
        [InlineData("sa1980-05-11T16:32:15.5000000", 7)] // Only dates with start time later than 1980-05-11T16:32:15.5000000 would match.
        [InlineData("sa1980-05-11T16:32:15.5000001", 7)] // Only dates with start time later than 1980-05-11T16:32:15.5000001 would match.
        [InlineData("sa1980-05-11T16:32:16", 7)] // Only dates with start time later than 1980-05-11T16:32:16.9999999 would match.
        [InlineData("sa1980-05-11T16:33", 7)] // Only dates with start time later than 1980-05-11T16:33:59.9999999 would match.
        [InlineData("sa1980-05-12", 7)] // Only dates with start time later than 1980-05-12T23:59:59.9999999 would match.
        [InlineData("sa1980-06", 7)] // Only dates with start time later than 1980-06-30T23:59:59.9999999 would match.
        ...
        [InlineData("eb1980-05-11T16:32", 0)] // Only dates with end time earlier than 1980-05-11T16:32:00.0000000 would match.
        ...
        [InlineData("eb1980-05-11T16:32:15.5000001", 0, 6)] // Only dates with end time earlier than 1980-05-11T16:32:15.5000001 would match.
        [InlineData("eb1980-05-11T16:32:16", 0, 5, 6)] // Only dates with end time later than 1980-05-11T16:32:16.0000000 would match.
        [InlineData("eb1980-05-11T16:33", 0, 4, 5, 6)] // Only dates with end time earlier than 1980-05-11T16:33:00.0000000 would match.
        [InlineData("eb1980-05-12", 0, 3, 4, 5, 6)] // Only dates with end time earlier than 1980-05-12T00:00:00.0000000 would match.
        [InlineData("eb1980-06", 0, 2, 3, 4, 5, 6)] // Only dates with end time earlier than 1980-06-01T00:00:00.0000000 would match.
        [InlineData("eb1981-01-01T00:00:00.0000001", 0, 1, 2, 3, 4, 5, 6)] // Only dates with end time earlier than 1981-01-01T00:00:00.0000001 would match.
