...
namespace Microsoft.Health.Fhir.Tests.E2E.Rest.Search
{
    ...
    public class SearchDurationTests : IClassFixture<HttpIntegrationTestFixture>
    {
        ...
        public async Task WhenSearchingForDurationOnEncounter_GivenAnR4Server_TheServerResultsAreReturnedCorrectly()
        {
            ...
            FhirResponse<Encounter> saved = await Client.CreateAsync(encounter);
