...
namespace Microsoft.Health.Fhir.Tests.E2E.Rest.Search
{
    ...
    public class AlwaysFailingSearchParameterStatusDataStore : ISearchParameterStatusDataStore
    {
        ...
        public Task UpsertStatuses(IReadOnlyList<ResourceSearchParameterStatus> statuses, CancellationToken cancellationToken, long? reindexId = null) => Task.CompletedTask;
