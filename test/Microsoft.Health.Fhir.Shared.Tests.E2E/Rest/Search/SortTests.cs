...
namespace Microsoft.Health.Fhir.Tests.E2E.Rest.Search
{
    ...
    public class SortTests : SearchTestsBase<HttpIntegrationTestFixture>
    {
        ...
        [Fact(Skip = "The limitation of continuation token across partitions when order by desc")]
        public async Task GivenMoreThanTenResources_WhenSearchedWithLastUpdatedAsSortParam_ThenPaginatedResourcesReturnedInDescendingOrder()
        {
            var newResources = new List<Resource>();
            var tag = Guid.NewGuid().ToString();
