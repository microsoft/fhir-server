...
{
    public class RevIncludeSearchTestFixture : HttpIntegrationTestFixture
    {
        public RevIncludeSearchTestFixture(DataStore dataStore, Format format, TestFhirServerFactory testFhirServerFactory)
