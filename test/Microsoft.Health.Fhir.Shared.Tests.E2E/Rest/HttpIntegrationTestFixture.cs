        ...
        protected HttpIntegrationTestFixture(string targetProjectParentDirectory, DataStore dataStore, Format format)
        {
            ...
            switch (dataStore)
            {
                case DataStore.CosmosDb:
                    environmentUrl = Environment.GetEnvironmentVariable($"TestEnvironmentUrl{Constants.TestEnvironmentVariableVersionModifier}");
                    break;
                case DataStore.SqlServer:
                    environmentUrl = Environment.GetEnvironmentVariable($"TestEnvironmentUrl{Constants.TestEnvironmentVariableVersionModifier}_Sql");
                    break;
            }
