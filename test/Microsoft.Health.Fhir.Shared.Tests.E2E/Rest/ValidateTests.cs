...
namespace Microsoft.Health.Fhir.Tests.E2E.Rest
{
    ...
    public class ValidateTests : IClassFixture<HttpIntegrationTestFixture>
    {
        ...
        public async void GivenAValidateRequest_WhenAModeIsPassed_ThenAnExceptionIsReturned(string mode, string message, OperationOutcome.IssueType issueType)
        {
            ...
            var exception = await Assert.ThrowsAsync<Common.FhirException>(() => _client.ValidateAsync("Patient/$validate?mode=" + mode, payload));
            OperationOutcome outcome = exception.OperationOutcome;
        ...
        public async void GivenAValidateByIdRequest_WhenAModeIsPassed_ThenAnExceptionIsReturned(string mode, string message, OperationOutcome.IssueType issueType)
        {
            ...
            var exception = await Assert.ThrowsAsync<Common.FhirException>(() => _client.ValidateAsync("Patient/123/$validate?mode=" + mode, payload));
            OperationOutcome outcome = exception.OperationOutcome;
        ...
        public async void GivenAValidateRequest_WhenAModeIsPassedAsAParameter_ThenAnExceptionIsReturned(string mode, string message, OperationOutcome.IssueType issueType)
        {
            ...
            var exception = await Assert.ThrowsAsync<Common.FhirException>(() => _client.ValidateAsync("Patient/$validate", payload));
            OperationOutcome outcome = exception.OperationOutcome;
        ...
        public async void GivenAValidateByIdRequest_WhenAModeIsPassedAsAParameter_ThenAnExceptionIsReturned(string mode, string message, OperationOutcome.IssueType issueType)
        {
            ...
            var exception = await Assert.ThrowsAsync<Common.FhirException>(() => _client.ValidateAsync("Patient/123/$validate", payload));
            OperationOutcome outcome = exception.OperationOutcome;
        ...
        public async void GivenAValidateRequest_WhenAProfileIsPassed_ThenAnUnsuportedExceptionIsReturned()
        {
            ...
            var exception = await Assert.ThrowsAsync<Common.FhirException>(() => _client.ValidateAsync("Patient/$validate?profile=test", payload));
            OperationOutcome outcome = exception.OperationOutcome;
