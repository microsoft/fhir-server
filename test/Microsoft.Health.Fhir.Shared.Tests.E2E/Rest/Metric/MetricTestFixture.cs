...
namespace Microsoft.Health.Fhir.Tests.E2E.Rest.Audit
{
    public class MetricTestFixture : HttpIntegrationTestFixture<StartupWithMetricHandler>
    {
        ...
        {
            get => _metricHandler ?? (_metricHandler = (MetricHandler)(TestFhirServer as InProcTestFhirServer)?.Server.Host.Services.GetRequiredService<INotificationHandler<ApiResponseMetricNotification>>());
        }
    }
}
