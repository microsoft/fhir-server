...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
            ...
            IModelInfoProvider modelInfoProvider)
        {
            ...
            var searchParameters = searchParamCollection.Select((x, entryIndex) =>
            {
                ...
                {
                    AddIssue("Search Parameter Definition Invalid Resource", entryIndex);
                    return null;
                }
            }).ToList();
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
                ...
                {
                    AddIssue("Search Parameter Definition Invalid Definition Uri", entryIndex);
                    continue;
                }
                catch (ArgumentException)
                {
                    AddIssue("Search Parameter Definition Duplicated Entry", searchParameter.Url);
                    continue;
                }
            }
            ...
            foreach (var searchParameter in searchParameters)
            {
                ...
                if (string.Equals(searchParameter.Type, SearchParamType.Composite.GetLiteral(), StringComparison.OrdinalIgnoreCase))
                {
                    ...
                    {
                        AddIssue("Search Parameter Definition Invalid Component", searchParameter.Url);
                        continue;
                    }
...
#pragma warning disable CS8600 // Converting null literal or possible null value to non-nullable type.
                        ...
                        {
                            AddIssue(
                                "SearchParameterDefinitionInvalidComponentReference",
                                searchParameter.Url,
                                componentIndex);
                            continue;
                        }
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
                        ...
                        {
                            AddIssue(
                                "SearchParameterDefinitionComponentReferenceCannotBeComposite",
                                searchParameter.Url,
                                componentIndex);
                            continue;
                        }
                        ...
                        {
                            AddIssue(
                                "SearchParameterDefinitionInvalidComponentExpression",
                                searchParameter.Url,
                                componentIndex);
                            continue;
                        }
                ...
                if (bases.Count == 0)
                {
                    AddIssue("SearchParameterDefinitionBaseNotDefined", searchParameter.Url);
                    continue;
                }
                ...
                for (int baseElementIndex = 0; baseElementIndex < bases.Count; baseElementIndex++)
                {
                    ...
                    else
                    {
                        ...
                        {
                            AddIssue("SearchParameterDefinitionInvalidExpression", searchParameter.Url);
                            continue;
                        }
                    }
            ...
            void EnsureNoIssues()
            {
                if (issues.Count != 0)
                {
                    throw new InvalidDefinitionException(
                        "SearchParameterDefinitionContainsInvalidEntry",
                        issues.ToArray());
                }
            }
        }
