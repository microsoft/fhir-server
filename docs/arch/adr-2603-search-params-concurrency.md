...
## Consequences
Data correctness will be enforced by ensuring that concurrent modifications to search parameters are properly serialized, preventing bad data.
