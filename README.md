...
- [Docker](samples/docker/README.md): Describes how to use get FHIR Server up and running on Docker.
- [Kubernetes](samples/kubernetes/README.md): Describes how to use deploy FHIR Server on Kubernetes cluster.
