...
namespace SMARTCustomOperations.AzureAuth.Services
{
    ...
    {
        private AzureAuthOperationsConfig _functionConfig;
        private IHttpClientFactory _httpClientFactory;
        private ILogger _logger;
        private IClientConfigService _clientConfigService;

        public AsymmetricAuthorizationService(AzureAuthOperationsConfig functionConfig, IHttpClientFactory httpClientFactory, ILogger<AsymmetricAuthorizationService> logger, IClientConfigService clientConfigService)
        {
