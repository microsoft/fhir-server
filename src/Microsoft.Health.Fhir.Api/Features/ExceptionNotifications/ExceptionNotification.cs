...
{
    /// <summary>
    /// A mediator notification containing information about exceptions with the context of the current request.
    /// Consume these via the mediator to collect stats about exceptions.
    /// </summary>
