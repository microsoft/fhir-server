...
namespace Microsoft.Health.Fhir.Api.Features.Container
{
    ...
    /// it is no longer guranteed to be called. It is meant for components that need to be initialized before the web requests can be
    ...
    {
        /// <summary>
        /// Guranteed to be called once per request, until it returns a successfully completed task, after which, as an optimization, it might no longer be called.
        /// </summary>
