...
{
    public class MoneyToQuantitySearchValueTypeConverterTests : FhirTypedElementToSearchValueTypeConverterTests<MoneyToQuantitySearchValueTypeConverter, Money>
    {
        [Fact]
