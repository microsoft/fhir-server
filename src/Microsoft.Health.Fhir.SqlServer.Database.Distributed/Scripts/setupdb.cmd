...
echo Running: sqlpackage.exe /Action:Publish /SourceFile:"%~dp0..\Microsoft.Health.Fhir.SqlServer.Database.Distributed.dacpac" /TargetConnectionString:%StoreConnectionString% /p:AllowDropBlockingAssemblies=true /p:NoAlterStatementsToChangeClrTypes=true /p:AllowIncompatiblePlatform=true /p:IncludeCompositeObjects=true
sqlpackage.exe /Action:Publish /SourceFile:"%~dp0..\Microsoft.Health.Fhir.SqlServer.Database.Distributed.dacpac" /TargetConnectionString:%StoreConnectionString% /p:AllowDropBlockingAssemblies=true /p:NoAlterStatementsToChangeClrTypes=true /p:AllowIncompatiblePlatform=true /p:IncludeCompositeObjects=true
