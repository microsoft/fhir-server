...
namespace Microsoft.Health.Fhir.Core.Features.Search.Converters
{
    ...
    /// </summary>
    public class ResourceReferenceToReferenceSearchValueTypeConverter : FhirElementToSearchValueTypeConverter<ResourceReference, ReferenceSearchValue>
    {
        private readonly IReferenceSearchValueParser _referenceSearchValueParser;

        public ResourceReferenceToReferenceSearchValueTypeConverter(IReferenceSearchValueParser referenceSearchValueParser)
        {
        ...
        protected override IEnumerable<ReferenceSearchValue> ConvertTo(ResourceReference value)
        {
