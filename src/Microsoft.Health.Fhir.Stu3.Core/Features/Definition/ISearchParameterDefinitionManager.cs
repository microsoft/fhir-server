...
namespace Microsoft.Health.Fhir.Core.Features.Definition
{
    ...
    public interface ISearchParameterDefinitionManager
    {
        ...
        IEnumerable<SearchParameter> GetSearchParameters(string resourceType);
        ...
        bool TryGetSearchParameter(string resourceType, string name, out SearchParameter searchParameter);
        ...
        SearchParameter GetSearchParameter(string resourceType, string name);
