...
namespace Microsoft.Health.Fhir.Core.UnitTests.Features.Search
{
    ...
    public partial class SearchOptionsFactoryTests
    {
        ...
        public void GivenASupportedSearchParam_WhenCreated_ThenCorrectExpressionShouldBeGenerated()
        {
            ...
            _expressionParser.Parse(resourceType.ToString(), paramName, value, false).Returns(expression);
        ...
        public void GivenMultipleSupportedSearchParams_WhenCreated_ThenCorrectExpressionShouldBeGenerated()
        {
            ...
            _expressionParser.Parse(resourceType.ToString(), paramName1, value1, false).Returns(expression1);
            _expressionParser.Parse(resourceType.ToString(), paramName2, value2, false).Returns(expression2);
        ...
        public void GivenANotSupportedSearchParam_WhenCreated_ThenCorrectExpressionShouldBeGenerated()
        {
            ...
            _expressionParser.Parse(resourceType.ToString(), paramName1, value1, false).Returns(expression1);
            _expressionParser.Parse(resourceType.ToString(), paramName2, value2, false)
                .Returns(x => throw new SearchParameterNotSupportedException(x.ArgAt<string>(0), x.ArgAt<string>(1)));
            _expressionParser.Parse(resourceType.ToString(), paramName3, value3, false).Returns(expression3);
