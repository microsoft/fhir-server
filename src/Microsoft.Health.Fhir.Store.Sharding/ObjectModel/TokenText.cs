...
namespace Microsoft.Health.Fhir.Store.Sharding
{
    public class TokenText : PrimaryKey
    {
        ...
        public TokenText(SqlDataReader reader, bool isSharded, IDictionary<(ShardletId shardletId, short sequence), string> resourceIdMap = null)
        {
            if (isSharded)
            {
    ...
    {
        public static void WriteRow(NpgsqlBinaryImporter writer, TokenText row)
        {
