...
namespace Microsoft.Health.Fhir.Store.Sharding
{
    public class TokenQuantityCompositeSearchParam : PrimaryKey
    {
        ...
        public TokenQuantityCompositeSearchParam(SqlDataReader reader, bool isSharded, IDictionary<(ShardletId shardletId, short sequence), string> resourceIdMap = null)
        {
            if (isSharded)
            {
    ...
    {
        public static void WriteRow(NpgsqlBinaryImporter writer, TokenQuantityCompositeSearchParam row)
        {
