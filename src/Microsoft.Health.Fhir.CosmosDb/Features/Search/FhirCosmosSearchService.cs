            ...
            CancellationToken cancellationToken)
        {
            ...
            if (revIncludeExpressions.Count > 0)
            {
                ...
                foreach (IncludeExpression revIncludeExpression in revIncludeExpressions)
                {
                    ...
                    if (revIncludeExpression.AllowedResourceTypesByScope.Any() && revIncludeExpression.SourceResourceType == "*")
                    {
                    ...
                    if ((revIncludeExpression.AllowedResourceTypesByScope.Any() && revIncludeExpression.SourceResourceType == "*") || revIncludeExpression.SourceResourceType != "*")
                    {
