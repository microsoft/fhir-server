...
namespace Microsoft.Health.Fhir.CosmosDb.Features.Search
{
    public static class SearchValueConstants
    {
        ...
        public const string SelectedFields = "r.id,r.isSystem,r.partitionKey,r.lastModified,r.rawResource,r.request,r.isDeleted,r.resourceId,r.resourceTypeName,r.isHistory,r.version,r._self,r._etag, r.searchIndices, r.searchParameterHash";
    }
}
