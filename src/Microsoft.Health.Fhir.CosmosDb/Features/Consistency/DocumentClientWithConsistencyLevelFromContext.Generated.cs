...
{
    internal partial class DocumentClientWithConsistencyLevelFromContext : Microsoft.Azure.Documents.IDocumentClient, System.IDisposable
    {
        private readonly Microsoft.Azure.Documents.IDocumentClient _inner;
        private DocumentClientWithConsistencyLevelFromContext(Microsoft.Azure.Documents.IDocumentClient inner)
        {
        ...
        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.StoredProcedureResponse<TValue>> Microsoft.Azure.Documents.IDocumentClient.ExecuteStoredProcedureAsync<TValue>(System.Uri storedProcedureUri, System.Object[] procedureParams)
        {
            return ProcessResponse(await _inner.ExecuteStoredProcedureAsync<TValue>(storedProcedureUri, procedureParams));
        }

        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.StoredProcedureResponse<TValue>> Microsoft.Azure.Documents.IDocumentClient.ExecuteStoredProcedureAsync<TValue>(System.Uri storedProcedureUri, Microsoft.Azure.Documents.Client.RequestOptions options, System.Object[] procedureParams)
        {
        ...
        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.ResourceResponse<Microsoft.Azure.Documents.Attachment>> Microsoft.Azure.Documents.IDocumentClient.CreateAttachmentAsync(System.String documentLink, System.Object attachment, Microsoft.Azure.Documents.Client.RequestOptions options)
        {
            return ProcessResponse(await _inner.CreateAttachmentAsync(documentLink, attachment, UpdateOptions(options)));
        }

        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.ResourceResponse<Microsoft.Azure.Documents.Attachment>> Microsoft.Azure.Documents.IDocumentClient.CreateAttachmentAsync(System.String documentLink, System.IO.Stream mediaStream, Microsoft.Azure.Documents.Client.MediaOptions options, Microsoft.Azure.Documents.Client.RequestOptions requestOptions)
        {
            return ProcessResponse(await _inner.CreateAttachmentAsync(documentLink, mediaStream, options, UpdateOptions(requestOptions)));
        }
        ...
        {
            return ProcessResponse(await _inner.CreateDocumentAsync(collectionLink, document, UpdateOptions(options), disableAutomaticIdGeneration));
        }
        ...
        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.ResourceResponse<Microsoft.Azure.Documents.Attachment>> Microsoft.Azure.Documents.IDocumentClient.DeleteAttachmentAsync(System.String attachmentLink, Microsoft.Azure.Documents.Client.RequestOptions options)
        {
            return ProcessResponse(await _inner.DeleteAttachmentAsync(attachmentLink, UpdateOptions(options)));
        }
        ...
        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.ResourceResponse<Microsoft.Azure.Documents.Document>> Microsoft.Azure.Documents.IDocumentClient.DeleteDocumentAsync(System.String documentLink, Microsoft.Azure.Documents.Client.RequestOptions options)
        {
            return ProcessResponse(await _inner.DeleteDocumentAsync(documentLink, UpdateOptions(options)));
        }
        ...
        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.ResourceResponse<Microsoft.Azure.Documents.Attachment>> Microsoft.Azure.Documents.IDocumentClient.ReplaceAttachmentAsync(Microsoft.Azure.Documents.Attachment attachment, Microsoft.Azure.Documents.Client.RequestOptions options)
        {
            return ProcessResponse(await _inner.ReplaceAttachmentAsync(attachment, UpdateOptions(options)));
        }
        ...
        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.ResourceResponse<Microsoft.Azure.Documents.Document>> Microsoft.Azure.Documents.IDocumentClient.ReplaceDocumentAsync(System.String documentLink, System.Object document, Microsoft.Azure.Documents.Client.RequestOptions options)
        {
            return ProcessResponse(await _inner.ReplaceDocumentAsync(documentLink, document, UpdateOptions(options)));
        }

        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.ResourceResponse<Microsoft.Azure.Documents.Document>> Microsoft.Azure.Documents.IDocumentClient.ReplaceDocumentAsync(Microsoft.Azure.Documents.Document document, Microsoft.Azure.Documents.Client.RequestOptions options)
        {
            return ProcessResponse(await _inner.ReplaceDocumentAsync(document, UpdateOptions(options)));
        }
        ...
        System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.MediaResponse> Microsoft.Azure.Documents.IDocumentClient.UpdateMediaAsync(System.String mediaLink, System.IO.Stream mediaStream, Microsoft.Azure.Documents.Client.MediaOptions options)
        {
            return _inner.UpdateMediaAsync(mediaLink, mediaStream, options);
        }

        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.ResourceResponse<Microsoft.Azure.Documents.Attachment>> Microsoft.Azure.Documents.IDocumentClient.ReadAttachmentAsync(System.String attachmentLink, Microsoft.Azure.Documents.Client.RequestOptions options)
        {
            return ProcessResponse(await _inner.ReadAttachmentAsync(attachmentLink, UpdateOptions(options)));
        }
        ...
        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.ResourceResponse<Microsoft.Azure.Documents.Document>> Microsoft.Azure.Documents.IDocumentClient.ReadDocumentAsync(System.String documentLink, Microsoft.Azure.Documents.Client.RequestOptions options)
        {
            return ProcessResponse(await _inner.ReadDocumentAsync(documentLink, UpdateOptions(options)));
        }
        ...
        System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.MediaResponse> Microsoft.Azure.Documents.IDocumentClient.ReadMediaAsync(System.String mediaLink)
        {
            return _inner.ReadMediaAsync(mediaLink);
        }

        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.FeedResponse<Microsoft.Azure.Documents.Attachment>> Microsoft.Azure.Documents.IDocumentClient.ReadAttachmentFeedAsync(System.String documentLink, Microsoft.Azure.Documents.Client.FeedOptions options)
        {
            return ProcessResponse(await _inner.ReadAttachmentFeedAsync(documentLink, UpdateOptions(options)));
        }
        ...
        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.FeedResponse<Microsoft.Azure.Documents.DocumentCollection>> Microsoft.Azure.Documents.IDocumentClient.ReadDocumentCollectionFeedAsync(System.String databaseLink, Microsoft.Azure.Documents.Client.FeedOptions options)
        {
            return ProcessResponse(await _inner.ReadDocumentCollectionFeedAsync(databaseLink, UpdateOptions(options)));
        }

        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.FeedResponse<System.Object>> Microsoft.Azure.Documents.IDocumentClient.ReadDocumentFeedAsync(System.String collectionLink, Microsoft.Azure.Documents.Client.FeedOptions options)
        {
            return ProcessResponse(await _inner.ReadDocumentFeedAsync(collectionLink, UpdateOptions(options)));
        }

        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.FeedResponse<Microsoft.Azure.Documents.StoredProcedure>> Microsoft.Azure.Documents.IDocumentClient.ReadStoredProcedureFeedAsync(System.String collectionLink, Microsoft.Azure.Documents.Client.FeedOptions options)
        {
            return ProcessResponse(await _inner.ReadStoredProcedureFeedAsync(collectionLink, UpdateOptions(options)));
        }

        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.FeedResponse<Microsoft.Azure.Documents.Trigger>> Microsoft.Azure.Documents.IDocumentClient.ReadTriggerFeedAsync(System.String collectionLink, Microsoft.Azure.Documents.Client.FeedOptions options)
        {
            return ProcessResponse(await _inner.ReadTriggerFeedAsync(collectionLink, UpdateOptions(options)));
        }

        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.FeedResponse<Microsoft.Azure.Documents.UserDefinedFunction>> Microsoft.Azure.Documents.IDocumentClient.ReadUserDefinedFunctionFeedAsync(System.String collectionLink, Microsoft.Azure.Documents.Client.FeedOptions options)
        {
            return ProcessResponse(await _inner.ReadUserDefinedFunctionFeedAsync(collectionLink, UpdateOptions(options)));
        }

        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.FeedResponse<Microsoft.Azure.Documents.Permission>> Microsoft.Azure.Documents.IDocumentClient.ReadPermissionFeedAsync(System.String userLink, Microsoft.Azure.Documents.Client.FeedOptions options)
        {
            return ProcessResponse(await _inner.ReadPermissionFeedAsync(userLink, UpdateOptions(options)));
        }

        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.FeedResponse<Microsoft.Azure.Documents.User>> Microsoft.Azure.Documents.IDocumentClient.ReadUserFeedAsync(System.String databaseLink, Microsoft.Azure.Documents.Client.FeedOptions options)
        {
            return ProcessResponse(await _inner.ReadUserFeedAsync(databaseLink, UpdateOptions(options)));
        }

        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.FeedResponse<Microsoft.Azure.Documents.Conflict>> Microsoft.Azure.Documents.IDocumentClient.ReadConflictFeedAsync(System.String collectionLink, Microsoft.Azure.Documents.Client.FeedOptions options)
        {
            return ProcessResponse(await _inner.ReadConflictFeedAsync(collectionLink, UpdateOptions(options)));
        }
        ...
        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.StoredProcedureResponse<TValue>> Microsoft.Azure.Documents.IDocumentClient.ExecuteStoredProcedureAsync<TValue>(System.String storedProcedureLink, System.Object[] procedureParams)
        {
            return ProcessResponse(await _inner.ExecuteStoredProcedureAsync<TValue>(storedProcedureLink, procedureParams));
        }

        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.StoredProcedureResponse<TValue>> Microsoft.Azure.Documents.IDocumentClient.ExecuteStoredProcedureAsync<TValue>(System.String storedProcedureLink, Microsoft.Azure.Documents.Client.RequestOptions options, System.Object[] procedureParams)
        {
        ...
        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.ResourceResponse<Microsoft.Azure.Documents.Attachment>> Microsoft.Azure.Documents.IDocumentClient.UpsertAttachmentAsync(System.String documentLink, System.Object attachment, Microsoft.Azure.Documents.Client.RequestOptions options)
        {
            return ProcessResponse(await _inner.UpsertAttachmentAsync(documentLink, attachment, UpdateOptions(options)));
        }

        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.ResourceResponse<Microsoft.Azure.Documents.Attachment>> Microsoft.Azure.Documents.IDocumentClient.UpsertAttachmentAsync(System.String documentLink, System.IO.Stream mediaStream, Microsoft.Azure.Documents.Client.MediaOptions options, Microsoft.Azure.Documents.Client.RequestOptions requestOptions)
        {
            return ProcessResponse(await _inner.UpsertAttachmentAsync(documentLink, mediaStream, options, UpdateOptions(requestOptions)));
        }

        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.ResourceResponse<Microsoft.Azure.Documents.Document>> Microsoft.Azure.Documents.IDocumentClient.UpsertDocumentAsync(System.String collectionLink, System.Object document, Microsoft.Azure.Documents.Client.RequestOptions options, System.Boolean disableAutomaticIdGeneration)
        {
            return ProcessResponse(await _inner.UpsertDocumentAsync(collectionLink, document, UpdateOptions(options), disableAutomaticIdGeneration));
        }
        ...
        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.ResourceResponse<Microsoft.Azure.Documents.Attachment>> Microsoft.Azure.Documents.IDocumentClient.CreateAttachmentAsync(System.Uri documentUri, System.Object attachment, Microsoft.Azure.Documents.Client.RequestOptions options)
        {
            return ProcessResponse(await _inner.CreateAttachmentAsync(documentUri, attachment, UpdateOptions(options)));
        }
        ...
        {
            return ProcessResponse(await _inner.CreateAttachmentAsync(documentUri, mediaStream, options, UpdateOptions(requestOptions)));
        }
        ...
        {
            return ProcessResponse(await _inner.CreateDocumentAsync(documentCollectionUri, document, UpdateOptions(options), disableAutomaticIdGeneration));
        }
        ...
        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.ResourceResponse<Microsoft.Azure.Documents.Attachment>> Microsoft.Azure.Documents.IDocumentClient.UpsertAttachmentAsync(System.Uri documentUri, System.Object attachment, Microsoft.Azure.Documents.Client.RequestOptions options)
        {
            return ProcessResponse(await _inner.UpsertAttachmentAsync(documentUri, attachment, UpdateOptions(options)));
        }
        ...
        {
            return ProcessResponse(await _inner.UpsertAttachmentAsync(documentUri, mediaStream, options, UpdateOptions(requestOptions)));
        }

        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.ResourceResponse<Microsoft.Azure.Documents.Document>> Microsoft.Azure.Documents.IDocumentClient.UpsertDocumentAsync(System.Uri documentCollectionUri, System.Object document, Microsoft.Azure.Documents.Client.RequestOptions options, System.Boolean disableAutomaticIdGeneration)
        {
            return ProcessResponse(await _inner.UpsertDocumentAsync(documentCollectionUri, document, UpdateOptions(options), disableAutomaticIdGeneration));
        }
        ...
        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.ResourceResponse<Microsoft.Azure.Documents.Attachment>> Microsoft.Azure.Documents.IDocumentClient.DeleteAttachmentAsync(System.Uri attachmentUri, Microsoft.Azure.Documents.Client.RequestOptions options)
        {
            return ProcessResponse(await _inner.DeleteAttachmentAsync(attachmentUri, UpdateOptions(options)));
        }
        ...
        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.ResourceResponse<Microsoft.Azure.Documents.Document>> Microsoft.Azure.Documents.IDocumentClient.DeleteDocumentAsync(System.Uri documentUri, Microsoft.Azure.Documents.Client.RequestOptions options)
        {
            return ProcessResponse(await _inner.DeleteDocumentAsync(documentUri, UpdateOptions(options)));
        }
        ...
        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.ResourceResponse<Microsoft.Azure.Documents.Attachment>> Microsoft.Azure.Documents.IDocumentClient.ReplaceAttachmentAsync(System.Uri attachmentUri, Microsoft.Azure.Documents.Attachment attachment, Microsoft.Azure.Documents.Client.RequestOptions options)
        {
            return ProcessResponse(await _inner.ReplaceAttachmentAsync(attachmentUri, attachment, UpdateOptions(options)));
        }
        ...
        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.ResourceResponse<Microsoft.Azure.Documents.Document>> Microsoft.Azure.Documents.IDocumentClient.ReplaceDocumentAsync(System.Uri documentUri, System.Object document, Microsoft.Azure.Documents.Client.RequestOptions options)
        {
            return ProcessResponse(await _inner.ReplaceDocumentAsync(documentUri, document, UpdateOptions(options)));
        }
        ...
        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.ResourceResponse<Microsoft.Azure.Documents.Attachment>> Microsoft.Azure.Documents.IDocumentClient.ReadAttachmentAsync(System.Uri attachmentUri, Microsoft.Azure.Documents.Client.RequestOptions options)
        {
            return ProcessResponse(await _inner.ReadAttachmentAsync(attachmentUri, UpdateOptions(options)));
        }
        ...
        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.ResourceResponse<Microsoft.Azure.Documents.Document>> Microsoft.Azure.Documents.IDocumentClient.ReadDocumentAsync(System.Uri documentUri, Microsoft.Azure.Documents.Client.RequestOptions options)
        {
            return ProcessResponse(await _inner.ReadDocumentAsync(documentUri, UpdateOptions(options)));
        }
        ...
        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.FeedResponse<Microsoft.Azure.Documents.Attachment>> Microsoft.Azure.Documents.IDocumentClient.ReadAttachmentFeedAsync(System.Uri documentUri, Microsoft.Azure.Documents.Client.FeedOptions options)
        {
            return ProcessResponse(await _inner.ReadAttachmentFeedAsync(documentUri, UpdateOptions(options)));
        }
        ...
        async System.Threading.Tasks.Task<Microsoft.Azure.Documents.Client.FeedResponse<System.Object>> Microsoft.Azure.Documents.IDocumentClient.ReadDocumentFeedAsync(System.Uri documentCollectionUri, Microsoft.Azure.Documents.Client.FeedOptions options)
        {
            return ProcessResponse(await _inner.ReadDocumentFeedAsync(documentCollectionUri, UpdateOptions(options)));
        }
