...
namespace Microsoft.Health.Fhir.Api.Features.Formatters
{
    public static class FormatterExtensions
    {
        ...
        internal static string GetClosestClientMediaType(this IReadOnlyCollection<TextOutputFormatter> outputFormatters, string contentType, IEnumerable<string> acceptHeaders)
        {
