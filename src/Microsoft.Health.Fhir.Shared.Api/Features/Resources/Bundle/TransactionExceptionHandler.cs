...
namespace Microsoft.Health.Fhir.Api.Features.Resources.Bundle
{
    ...
    {
        public static void ThrowTransactionException(string errorMessage, HttpStatusCode statusCode, OperationOutcome operationOutcome, bool isOperationCancelledByClient)
        {
            List<OperationOutcomeIssue> operationOutcomeIssues = GetOperationOutcomeIssues(operationOutcome.Issue);

            if (isOperationCancelledByClient)
            {
