...
namespace Microsoft.Health.Fhir.Api.Features.Resources
{
        ...
        IPipelineBehavior<ConditionalUpsertResourceRequest, UpsertResourceResponse>
    {
        ...
        public ProvenanceHeaderBehavior(FhirJsonPocoDeserializer fhirJsonParser, IHttpContextAccessor httpContextAccessor, IMediator mediator, IProvenanceHeaderState state)
        {
        ...
        private Provenance GetProvenanceFromHeader()
        {
            ...
            try
            {
                provenance = (Provenance)_fhirJsonParser.DeserializeResource(value);
            }
            catch
            {
