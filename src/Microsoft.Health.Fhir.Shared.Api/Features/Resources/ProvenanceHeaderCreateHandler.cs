...
{
    /// <summary>
    /// Handler for create request with "X-Provenance header".
    /// Creates resource and Provenance resource provided in "X-Provenance" header with it's target as resource.
    /// </summary>
    public sealed class ProvenanceHeaderCreateHandler : IRequestHandler<ProvenanceHeaderCreateRequest, RawResourceElement>
    {
        private readonly FhirJsonParser _fhirJsonParser;
        private readonly IMediator _mediator;

        public ProvenanceHeaderCreateHandler(FhirJsonParser fhirJsonParser, IMediator mediator)
        {
        ...
        public async Task<RawResourceElement> Handle(ProvenanceHeaderCreateRequest request, CancellationToken cancellationToken)
        {
