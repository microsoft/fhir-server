...
{
    public class ValidateActionPreProcessorTests
    {
        ...
        public ValidateActionPreProcessorTests()
        {
        ...
        public async Task GivenARequest_WhenAuthorizationDisabled_ThenGetApplicableResourcePermissionsShouldNotBeCalled()
        {
            ...
            var preProcessor = new ValidateActionPreProcessor<GetResourceRequest>(_authorizationPolicy, _fhirRequestContextAccessor, _securityOptions);
