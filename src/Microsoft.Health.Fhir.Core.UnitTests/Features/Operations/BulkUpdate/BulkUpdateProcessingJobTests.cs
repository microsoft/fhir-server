...
namespace Microsoft.Health.Fhir.Core.UnitTests.Features.Operations.BulkUpdate
{
    ...
    public class BulkUpdateProcessingJobTests
    {
        ...
        public async Task GivenProcessingJob_WhenJobIsRun_ThenResourcesAreUpdated()
        {
            ...
            var definition = new BulkUpdateDefinition(JobType.BulkUpdateProcessing, null, null, "test", "test", "test", null, isParallel: true);
            ...
            _updater.UpdateMultipleAsync(Arg.Any<string>(), Arg.Any<string>(), Arg.Any<int>(), Arg.Any<bool>(), Arg.Is<bool>(b => b == false), Arg.Any<IReadOnlyList<Tuple<string, string>>>(), Arg.Any<BundleResourceContext>(), Arg.Any<CancellationToken>())
            ...
            await _updater.ReceivedWithAnyArgs(1).UpdateMultipleAsync(Arg.Any<string>(), Arg.Any<string>(), Arg.Any<int>(), Arg.Any<bool>(), Arg.Is<bool>(b => b == false), Arg.Any<IReadOnlyList<Tuple<string, string>>>(), Arg.Any<BundleResourceContext>(), Arg.Any<CancellationToken>());
        ...
        [Fact]
        public async Task GivenProcessingJobWithIncludesContinuationToken_WhenJobIsRun_ThenIncludedResourcesAreUpdated()
        {
            _updater.ClearReceivedCalls();

            var searchParams = new List<Tuple<string, string>>()
            {
                new Tuple<string, string>(KnownQueryParameterNames.IncludesContinuationToken, KnownQueryParameterNames.IncludesContinuationToken),
            };
            var definition = new BulkUpdateDefinition(JobType.BulkUpdateProcessing, null, searchParams, "test", "test", "test", null, isParallel: true);
            var jobInfo = new JobInfo()
            {
                Id = 1,
                Definition = JsonConvert.SerializeObject(definition),
            ...
            _updater.UpdateMultipleAsync(Arg.Any<string>(), Arg.Any<string>(), Arg.Any<int>(), Arg.Any<bool>(), Arg.Any<bool>(), Arg.Any<IReadOnlyList<Tuple<string, string>>>(), Arg.Any<BundleResourceContext>(), Arg.Any<CancellationToken>())
                .Returns(args => substituteResults);
            ...
            await _updater.ReceivedWithAnyArgs(1).UpdateMultipleAsync(Arg.Any<string>(), Arg.Any<string>(), Arg.Any<int>(), Arg.Any<bool>(), true, Arg.Any<IReadOnlyList<Tuple<string, string>>>(), Arg.Any<BundleResourceContext>(), Arg.Any<CancellationToken>());
        }
        ...
        public async Task GivenProcessingJobWithSurrogateIds_WhenJobIsRun_ThenIdsAreAddedToSearchParametersAndResourcesAreUpdated()
        {
            ...
            await _updater.ReceivedWithAnyArgs(1).UpdateMultipleAsync(Arg.Any<string>(), Arg.Any<string>(), Arg.Any<int>(), Arg.Any<bool>(), Arg.Any<bool>(), Arg.Any<IReadOnlyList<Tuple<string, string>>>(), Arg.Any<BundleResourceContext>(), Arg.Any<CancellationToken>());
        ...
        [Fact]
        public async Task GivenProcessingJobWhenIncompleteOperationExceptionIsThrownd_WhenJobIsRun_ThenJobExecutionExceptionIsThrownAndPartialResultsAreHandled()
        {
            var definition = new BulkUpdateDefinition(JobType.BulkUpdateProcessing, null, null, "test", "test", "test", null, isParallel: true);
            var jobInfo = new JobInfo
            {
            ...
            _updater.UpdateMultipleAsync(Arg.Any<string>(), Arg.Any<string>(), Arg.Any<int>(), Arg.Any<bool>(), Arg.Any<bool>(), Arg.Any<IReadOnlyList<Tuple<string, string>>>(), Arg.Any<BundleResourceContext>(), Arg.Any<CancellationToken>()).Returns<Task<BulkUpdateResult>>(x => { throw incompleteException; });
        ...
        public async Task GivenProcessingJobWhenResourcesPatchFailedIsNotEmpty_WhenJobIsRun_ThrowsJobExecutionSoftFailureException()
        {
            ...
            _updater.UpdateMultipleAsync(Arg.Any<string>(), Arg.Any<string>(), Arg.Any<int>(), Arg.Any<bool>(), Arg.Any<bool>(), Arg.Any<IReadOnlyList<Tuple<string, string>>>(), Arg.Any<BundleResourceContext>(), Arg.Any<CancellationToken>()).Returns(Task.FromResult(result));
        ...
        public async Task GivenProcessingJobWhenNoResourcesUpdatedAndNoErrors_WhenJobIsRun_ThenReturnsEmptyResult()
        {
            ...
            _updater.UpdateMultipleAsync(Arg.Any<string>(), Arg.Any<string>(), Arg.Any<int>(), Arg.Any<bool>(), Arg.Any<bool>(), Arg.Any<IReadOnlyList<Tuple<string, string>>>(), Arg.Any<BundleResourceContext>(), Arg.Any<CancellationToken>()).Returns(Task.FromResult(emptyResult));
        ...
        public async Task GivenProcessingJobWhenUnexpectedExceptionIsThrownFromUpdateMultipleAsync_WhenJobIsRun_ThenExceptionIsPropagated()
        {
            ...
            _updater.UpdateMultipleAsync(Arg.Any<string>(), Arg.Any<string>(), Arg.Any<int>(), Arg.Any<bool>(), Arg.Any<bool>(), Arg.Any<IReadOnlyList<Tuple<string, string>>>(), Arg.Any<BundleResourceContext>(), Arg.Any<CancellationToken>()).Returns<Task<BulkUpdateResult>>(x => throw unexpectedException);
