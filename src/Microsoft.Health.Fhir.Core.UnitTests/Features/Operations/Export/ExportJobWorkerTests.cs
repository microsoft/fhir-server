...
namespace Microsoft.Health.Fhir.Core.UnitTests.Features.Operations.Export
{
    public class ExportJobWorkerTests
    {
        ...
        private ExportJobOutcome CreateExportJobOutcome()
        {
            ...
            return new ExportJobOutcome(new ExportJobRecord(exportRequest.RequestUri, exportRequest.RequestType, ExportFormatTags.ResourceName, null, null, null, "hash"), WeakETag.FromVersionId("0"));
        }
    }
}
