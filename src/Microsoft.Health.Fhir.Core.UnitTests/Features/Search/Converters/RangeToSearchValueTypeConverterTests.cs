...
{
    public class RangeToSearchValueTypeConverterTests : FhirElementToSearchValueTypeConverterTests<RangeToSearchValueTypeConverter, Range>
    {
        ...
        [InlineData(10, null)]
        [Theory]
        public void GivenRange_WhenConvertedToAQuantity_ThenAQuantityWithCorrectLowAndHighValuesIsCreated(int? low, int? high)
        {
        ...
        public void GivenRange_WhenConvertedToANumber_ThenANumberWithCorrectLowAndHighValuesIsCreated(int? low, int? high)
        {
            ...
            Test(
                ...
                new NumberSearchValue(low, high));
        }
    }
}
