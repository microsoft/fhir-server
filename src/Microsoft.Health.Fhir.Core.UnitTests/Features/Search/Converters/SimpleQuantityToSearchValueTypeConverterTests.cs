...
{
    public class SimpleQuantityToSearchValueTypeConverterTests : FhirElementToSearchValueTypeConverterTests<SimpleQuantityToSearchValueTypeConverter, SimpleQuantity>
    {
        [Fact]
