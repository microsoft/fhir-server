...
namespace Microsoft.Health.Fhir.Api.UnitTests.Extensions
{
    ...
    public class HttpRequestExtensionsTests
    {
        ...
        [InlineData("_count=4&_sort=name&name=AB&_has:HealthcareService:location:_id=00000000-0000-0000-0000-000000000000", 4)]
        [InlineData("_count=4&_sort=name&name=AB&_has%3AHealthcareService%3Alocation%3A_id=00000000-0000-0000-0000-000000000000", 4)]
        ...
        public async Task GivenAnUrlWithDuplicatedParameters_WhenEncoded_ThenCompareTheExpectedResults()
        {
            ...
            IReadOnlyList<Tuple<string, string>> expectedParameters = new Tuple<string, string>[]
            {
                Tuple.Create("name:missing", "false,true"),
            };
