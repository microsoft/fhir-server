...
namespace Microsoft.Health.Fhir.Api.UnitTests.Features.Metrics
{
    public class MetricFilterAttributeTests
    {
        ...
        private readonly ILogger<MetricFilterAttribute> _logger = NullLogger<MetricFilterAttribute>.Instance;

        private const string ControllerName = "controller";
        private const string ActionName = "action";

        private readonly MetricFilterAttribute _filter;
        ...
        public MetricFilterAttributeTests()
        {
            ...
            _filter = new MetricFilterAttribute(_mediator, _fhirRequestContextAccessor, _logger);
        ...
        public async Task GivenRequestPathButNoStorageRequestMetrics_WhenInvoked_EmitsMediatRApiEvents()
        {
            ...
            await _mediator.Received(1).Publish<ApiResponseNotification>(Arg.Any<ApiResponseNotification>(), Arg.Any<CancellationToken>());
        }
