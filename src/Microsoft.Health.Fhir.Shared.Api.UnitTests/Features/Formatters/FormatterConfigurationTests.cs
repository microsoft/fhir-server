...
namespace Microsoft.Health.Fhir.Api.UnitTests.Features.Formatters
{
    ...
    public class FormatterConfigurationTests
    {
        ...
        public FormatterConfigurationTests()
        {
            ...
            _fhirJsonOutputFormatter = new FhirJsonOutputFormatter(serializer, Deserializers.ResourceDeserializer, ArrayPool<char>.Shared, new BundleSerializer(serializer), ModelInfoProvider.Instance);
