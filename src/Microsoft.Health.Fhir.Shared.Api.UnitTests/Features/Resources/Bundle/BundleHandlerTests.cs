...
namespace Microsoft.Health.Fhir.Api.UnitTests.Features.Resources.Bundle
{
    ...
    public class BundleHandlerTests
    {
        ...
        public async Task GivenAnEmptyBatchBundle_WhenProcessed_ReturnsABundleResponseWithNoEntries()
        {
            ...
            BundleResponse bundleResponse = await _bundleHandler.Handle(bundleRequest, TestContext.Current.CancellationToken);
        ...
        public async Task GivenATransaction_WithACrashDuringCSharpTransaction_ReturnAProperError()
        {
            ...
            var bundleRequest = new BundleRequest(bundle.ToResourceElement());
            FhirTransactionFailedException fhirTfe = await Assert.ThrowsAsync<FhirTransactionFailedException>(async () => await _bundleHandler.Handle(bundleRequest, TestContext.Current.CancellationToken));
        ...
        public async Task GivenATransactionBundleRequestWithNullUrl_WhenProcessing_ReturnsABadRequest()
        {
            ...
            await Assert.ThrowsAsync<RequestNotValidException>(async () => await _bundleHandler.Handle(bundleRequest, TestContext.Current.CancellationToken));
        }
        ...
        public async Task GivenAConfigurationEntryLimit_WhenExceeded_ThenBundleEntryLimitExceededExceptionShouldBeThrown()
        {
            ...
            var exception = await Assert.ThrowsAsync<BundleEntryLimitExceededException>(async () => await _bundleHandler.Handle(bundleRequest, TestContext.Current.CancellationToken));
        ...
        public async Task GivenAFailedTransaction_WhenProcessed_ThenNoNotificationWillBeEmitted()
        {
            ...
            var bundleRequest = new BundleRequest(bundle.ToResourceElement());
            await Assert.ThrowsAsync<FhirTransactionFailedException>(() => _bundleHandler.Handle(bundleRequest, TestContext.Current.CancellationToken));
