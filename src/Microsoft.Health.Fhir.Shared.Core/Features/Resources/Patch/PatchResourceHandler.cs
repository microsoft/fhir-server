...
namespace Microsoft.Health.Fhir.Core.Features.Resources.Patch
{
    public class PatchResourceHandler : BaseResourceHandler, IRequestHandler<PatchResourceRequest, UpsertResourceResponse>
    {
        ...
        public async Task<UpsertResourceResponse> HandleAsync(PatchResourceRequest request, CancellationToken cancellationToken)
        {
            ...
            return await _mediator.SendAsync<UpsertResourceResponse>(new UpsertResourceRequest(patchedResource, request.BundleResourceContext, request.WeakETag), cancellationToken);
        }
    }
}
