...
{
    public class FhirPatchResourceHandler : BaseResourceHandler, IRequestHandler<FhirPatchResourceRequest, UpsertResourceResponse>
    {
        private readonly FhirParameterPatchService _patchService;
        private readonly IMediator _mediator;

        public FhirPatchResourceHandler(
            IMediator mediator,
        ...
        public async Task<UpsertResourceResponse> Handle(FhirPatchResourceRequest request, CancellationToken cancellationToken)
        {
            ...
            var patchedResource = _patchService.Patch(currentDoc, request.ParamResource, request.WeakETag);
