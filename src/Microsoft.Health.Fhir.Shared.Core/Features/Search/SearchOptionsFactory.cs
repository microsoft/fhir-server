...
namespace Microsoft.Health.Fhir.Core.Features.Search
{
    public class SearchOptionsFactory : ISearchOptionsFactory
    {
        ...
        public SearchOptions Create(string compartmentType, string compartmentId, PartialDateTime start, PartialDateTime end, PartialDateTime since, string type, int? count, string continuationToken)
        {
            ...
            SearchOptions searchOptions = Create(compartmentType, compartmentId, null, queryParameters);
            ...
            List<string> nonDateResourceTypes = type == null
                ? Enum.GetNames(typeof(ResourceType)).Except(clinicalDateInfo.BaseResourceTypes).ToList()
                : Enum.GetNames(typeof(ResourceType)).Except(clinicalDateInfo.BaseResourceTypes).Intersect(type.SplitByOrSeparator()).ToList();
