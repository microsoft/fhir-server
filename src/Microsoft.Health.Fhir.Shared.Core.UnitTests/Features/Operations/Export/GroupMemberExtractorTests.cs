...
namespace Microsoft.Health.Fhir.Core.UnitTests.Features.Operations.Export
{
    public class GroupMemberExtractorTests
    {
        ...
        public GroupMemberExtractorTests()
        {
            ...
            var resourceWrapper = new ResourceWrapper("test", "test", "test", new RawResource("test", FhirResourceFormat.Json, metaSet: false), null, DateTimeOffset.Now, false, null, null, null);
