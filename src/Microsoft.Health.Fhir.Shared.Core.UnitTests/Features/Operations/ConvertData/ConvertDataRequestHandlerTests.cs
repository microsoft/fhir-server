...
namespace Microsoft.Health.Fhir.Shared.Core.UnitTests.Features.Operations.ConvertData
{
    public class ConvertDataRequestHandlerTests
    {
        ...
        {
            return new ConvertDataRequest(GetSampleCCDAMessage(), ConversionInputDataType.CCDA, "microsofthealth", true, ImageInfo.GetDefaultTemplateImageReferenceByDatatype(Liquid.Converter.Models.DataType.Cda), "CCD");
        }
