...
namespace Microsoft.Health.Fhir.Core.UnitTests.Features.Resources
{
    ...
    public partial class ResourceHandlerTests
    {
        ...
        public ResourceHandlerTests()
        {
            ...
            collection.Add(x => new ConditionalDeleteResourceHandler(_fhirDataStore, lazyConformanceProvider, _resourceWrapperFactory, _searchService, x.GetService<IMediator>(), _resourceIdProvider, _authorizationService, Options.Create<CoreFeatureConfiguration>(new CoreFeatureConfiguration()))).Singleton().AsSelf().AsImplementedInterfaces();
