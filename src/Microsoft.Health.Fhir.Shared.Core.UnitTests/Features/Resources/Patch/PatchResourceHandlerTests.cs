...
public class PatchResourceHandlerTests
{
    ...
    [Fact]
    public async Task GivenAPatchResourceHandler_WhenUserHasUpdatePermission_ThenPatchShouldSucceed()
    {
        // Arrange
        IAuthorizationService<DataActions> authService = Substitute.For<IAuthorizationService<DataActions>>();
        IFhirDataStore fhirDataStore = Substitute.For<IFhirDataStore>();
    ...
    [Fact]
    public async Task GivenAPatchResourceHandler_WhenUserHasLegacyReadAndWritePermissions_ThenPatchShouldSucceed()
    {
        // Arrange
        IAuthorizationService<DataActions> authService = Substitute.For<IAuthorizationService<DataActions>>();
        IFhirDataStore fhirDataStore = Substitute.For<IFhirDataStore>();
    ...
    [Fact]
    public async Task GivenAPatchResourceHandler_WhenUserLacksUpdatePermission_ThenUnauthorizedExceptionIsThrown()
    {
        // Arrange
        IAuthorizationService<DataActions> authService = Substitute.For<IAuthorizationService<DataActions>>();
        IFhirDataStore fhirDataStore = Substitute.For<IFhirDataStore>();
    ...
    [Fact]
    public async Task GivenAPatchResourceHandler_WhenUserHasOnlyReadPermission_ThenUnauthorizedExceptionIsThrown()
    {
        // Arrange
        IAuthorizationService<DataActions> authService = Substitute.For<IAuthorizationService<DataActions>>();
        IFhirDataStore fhirDataStore = Substitute.For<IFhirDataStore>();
    ...
    [Fact]
    public async Task GivenAPatchResourceHandler_WhenUserHasOnlyWritePermission_ThenUnauthorizedExceptionIsThrown()
    {
        // Arrange
        IAuthorizationService<DataActions> authService = Substitute.For<IAuthorizationService<DataActions>>();
        IFhirDataStore fhirDataStore = Substitute.For<IFhirDataStore>();
