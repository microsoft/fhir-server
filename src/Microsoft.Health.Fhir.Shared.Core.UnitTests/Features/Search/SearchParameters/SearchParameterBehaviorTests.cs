...
namespace Microsoft.Health.Fhir.Core.UnitTests.Features.Search
{
    ...
    public class SearchParameterBehaviorTests
    {
        ...
        [Fact]
        public async Task GivenAnUpsertResourceRequest_WhenUrlIsOwnedByASystemDefinedSearchParameter_ThenMethodNotAllowedThrownAndNoStatusQueued()
        {
        ...
        [Fact]
        public async Task GivenAnUpsertResourceRequest_WhenUrlIsRegisteredButNotSystemDefined_ThenStatusIsQueuedAsSupported()
        {
