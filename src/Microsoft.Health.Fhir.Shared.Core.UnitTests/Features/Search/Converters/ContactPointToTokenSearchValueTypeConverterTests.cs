...
{
    public class ContactPointToTokenSearchValueTypeConverterTests : FhirTypedElementToSearchValueTypeConverterTests<ContactPointToTokenSearchValueTypeConverter, ContactPoint>
    {
        [Fact]
