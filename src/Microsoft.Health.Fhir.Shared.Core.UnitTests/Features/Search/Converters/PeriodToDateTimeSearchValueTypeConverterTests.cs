...
{
    public class PeriodToDateTimeSearchValueTypeConverterTests : FhirTypedElementToSearchValueTypeConverterTests<PeriodToDateTimeSearchValueTypeConverter, Period>
    {
        [Theory]
