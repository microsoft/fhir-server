...
{
    public class BooleanToBooleanSearchValueTypeConverterTests : FhirTypedElementToSearchValueTypeConverterTests<BooleanToTokenSearchValueTypeConverter, FhirBoolean>
    {
        [Fact]
