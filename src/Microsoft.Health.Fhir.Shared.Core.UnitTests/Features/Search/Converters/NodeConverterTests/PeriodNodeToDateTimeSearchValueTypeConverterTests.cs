...
{
    public class PeriodNodeToDateTimeSearchValueTypeConverterTests : FhirNodeToSearchValueTypeConverterTests<PeriodNodeToDateTimeSearchValueTypeConverter, Period>
    {
        [Theory]
