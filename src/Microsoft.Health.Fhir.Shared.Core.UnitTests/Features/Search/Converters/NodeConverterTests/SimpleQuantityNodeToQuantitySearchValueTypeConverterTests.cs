...
{
    public class SimpleQuantityNodeToQuantitySearchValueTypeConverterTests : FhirNodeToSearchValueTypeConverterTests<SimpleQuantityNodeToQuantitySearchValueTypeConverter, SimpleQuantity>
    {
        [Fact]
