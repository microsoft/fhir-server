...
{
    public class ResourceReferenceNodeToReferenceSearchValueTypeConverterTests
    {
        private readonly IReferenceSearchValueParser _referenceSearchValueParser = Substitute.For<IReferenceSearchValueParser>();
        private readonly ResourceReferenceNodeToReferenceSearchValueTypeConverter _converter;
        private readonly ResourceReference _reference = new ResourceReference();

        public ResourceReferenceNodeToReferenceSearchValueTypeConverterTests()
        {
            _converter = new ResourceReferenceNodeToReferenceSearchValueTypeConverter(_referenceSearchValueParser);
        }
