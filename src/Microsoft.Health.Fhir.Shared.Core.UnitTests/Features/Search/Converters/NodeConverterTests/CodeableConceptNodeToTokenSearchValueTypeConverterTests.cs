...
{
    public class CodeableConceptNodeToTokenSearchValueTypeConverterTests : FhirNodeToSearchValueTypeConverterTests<CodeableConceptNodeToTokenSearchValueTypeConverter, CodeableConcept>
    {
