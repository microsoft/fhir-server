...
{
    public class MarkdownToStringSearchValueTypeConverterTests : FhirTypedElementToSearchValueTypeConverterTests<MarkdownToStringSearchValueTypeConverter, Markdown>
    {
        [Fact]
