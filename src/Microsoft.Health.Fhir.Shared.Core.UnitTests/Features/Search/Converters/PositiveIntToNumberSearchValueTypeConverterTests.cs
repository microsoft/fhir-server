...
{
    public class PositiveIntToNumberSearchValueTypeConverterTests : FhirTypedElementToSearchValueTypeConverterTests<IntegerToNumberSearchValueTypeConverter, PositiveInt>
    {
        [Fact]
