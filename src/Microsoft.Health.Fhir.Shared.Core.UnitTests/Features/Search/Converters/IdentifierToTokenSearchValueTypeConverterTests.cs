...
{
    public class IdentifierToTokenSearchValueTypeConverterTests : FhirTypedElementToSearchValueTypeConverterTests<IdentifierToTokenSearchValueTypeConverter, Identifier>
    {
        [Fact]
