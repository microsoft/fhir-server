...
{
    public class QuantityToQuantitySearchValueTypeConverterTests : FhirTypedElementToSearchValueTypeConverterTests<QuantityToQuantitySearchValueTypeConverter, Quantity>
    {
        [Fact]
