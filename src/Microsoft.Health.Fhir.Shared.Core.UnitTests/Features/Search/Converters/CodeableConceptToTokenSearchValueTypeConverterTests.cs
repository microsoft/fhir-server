...
{
    public class CodeableConceptToTokenSearchValueTypeConverterTests : FhirTypedElementToSearchValueTypeConverterTests<CodeableConceptToTokenSearchValueTypeConverter, CodeableConcept>
    {
