...
{
    public class StringToStringSearchValueTypeConverterTests : FhirTypedElementToSearchValueTypeConverterTests<StringToStringSearchValueConverter, FhirString>
    {
        [Fact]
