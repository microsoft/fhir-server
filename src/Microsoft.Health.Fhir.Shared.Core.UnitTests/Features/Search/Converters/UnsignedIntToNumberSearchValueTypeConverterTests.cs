...
{
    public class UnsignedIntToNumberSearchValueTypeConverterTests : FhirTypedElementToSearchValueTypeConverterTests<IntegerToNumberSearchValueTypeConverter, UnsignedInt>
    {
        [Fact]
