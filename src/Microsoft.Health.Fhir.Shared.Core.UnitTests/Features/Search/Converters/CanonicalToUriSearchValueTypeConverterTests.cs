...
{
    #if !Stu3
    public class CanonicalToUriSearchValueTypeConverterTests : FhirTypedElementToSearchValueTypeConverterTests<CanonicalToUriSearchValueTypeConverter, Canonical>
    {
        [Fact]
