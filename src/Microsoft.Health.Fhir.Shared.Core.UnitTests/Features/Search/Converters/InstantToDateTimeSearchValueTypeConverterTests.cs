...
{
    public class InstantToDateTimeSearchValueTypeConverterTests : FhirTypedElementToSearchValueTypeConverterTests<InstantToDateTimeSearchValueTypeConverter, Instant>
    {
        [Fact]
