...
{
    public class DecimalToDecimalSearchValueTypeConverterTests : FhirTypedElementToSearchValueTypeConverterTests<DecimalToNumberSearchValueTypeConverter, FhirDecimal>
    {
        [Fact]
