...
{
    public class DateTimeToDateTimeSearchValueTypeConverterTests : FhirTypedElementToSearchValueTypeConverterTests<DateToDateTimeSearchValueTypeConverter, FhirDateTime>
    {
        [Fact]
