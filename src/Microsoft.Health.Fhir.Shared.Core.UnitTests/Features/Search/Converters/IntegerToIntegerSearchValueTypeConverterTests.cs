...
{
    public class IntegerToIntegerSearchValueTypeConverterTests : FhirTypedElementToSearchValueTypeConverterTests<IntegerToNumberSearchValueTypeConverter, Integer>
    {
        [Fact]
