...
{
    public class CodeToTokenSearchValueTypeConverterTests : FhirInstanceToSearchValueTypeConverterTests<Code>
    {
        public CodeToTokenSearchValueTypeConverterTests()
            : base()
        {
        }
        ...
        protected override async Task<ITypedElementToSearchValueTypeConverter> GetTypeConverterAsync()
        {
            ...
            return new CodeToTokenSearchValueTypeConverter(resolver);
        }
