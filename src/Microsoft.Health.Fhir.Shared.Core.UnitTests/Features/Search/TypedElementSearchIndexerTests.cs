...
namespace Microsoft.Health.Fhir.Core.UnitTests.Features.Search
{
    ...
    public class TypedElementSearchIndexerTests
    {
        ...
        public TypedElementSearchIndexerTests()
        {
            ...
            _searchIndexer = new TypedElementSearchIndexer(supportedSearchParameterDefinitionManager, typedElementToSearchValueConverterManager, referenceToElementResolver, modelInfoProvider, new FirelyFhirPathEvaluator(), logger);
