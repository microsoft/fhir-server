...
{
    internal class BulkCompartmentAssignmentRowGenerator : ITableValuedParameterRowGenerator<IReadOnlyList<ResourceMetadata>, VLatest.BulkCompartmentAssignmentTableTypeRow>
    {
        ...
        public BulkCompartmentAssignmentRowGenerator(SqlServerFhirModel model)
        {
            EnsureArg.IsNotNull(model, nameof(model));
            _model = model;
        }

        public IEnumerable<VLatest.BulkCompartmentAssignmentTableTypeRow> GenerateRows(IReadOnlyList<ResourceMetadata> resources)
        {
            EnsureInitialized();
            ...
            for (var index = 0; index < resources.Count; index++)
            {
                ...
                if (compartments.PatientCompartmentEntry != null)
                {
                    ...
                    {
                        yield return new VLatest.BulkCompartmentAssignmentTableTypeRow(index, _patientCompartmentId, entry);
                    }
                }
                ...
                if (compartments.EncounterCompartmentEntry != null)
                {
                    ...
                    {
                        yield return new VLatest.BulkCompartmentAssignmentTableTypeRow(index, _encounterCompartmentId, entry);
                    }
                }
                ...
                if (compartments.RelatedPersonCompartmentEntry != null)
                {
                    ...
                    {
                        yield return new VLatest.BulkCompartmentAssignmentTableTypeRow(index, _relatedPersonCompartmentId, entry);
                    }
                }
                ...
                if (compartments.PractitionerCompartmentEntry != null)
                {
                    ...
                    {
                        yield return new VLatest.BulkCompartmentAssignmentTableTypeRow(index, _practitionerCompartmentId, entry);
                    }
                }
                ...
                if (compartments.DeviceCompartmentEntry != null)
                {
                    ...
                    {
                        yield return new VLatest.BulkCompartmentAssignmentTableTypeRow(index, _deviceCompartmentId, entry);
                    }
                }
            }
        }
