...
{
    internal abstract class CompositeSearchParameterRowGenerator<TSearchValue, TRow> : SearchParameterRowGenerator<TSearchValue, TRow>
        ...
        where TRow : struct
    {
        ...
        protected CompositeSearchParameterRowGenerator(SqlServerFhirModel model)
            : base(model)
        {
        }
