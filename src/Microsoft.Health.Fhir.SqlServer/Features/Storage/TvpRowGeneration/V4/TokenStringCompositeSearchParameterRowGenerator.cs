...
{
    internal class TokenStringCompositeSearchParameterRowGenerator : CompositeSearchParameterRowGenerator<(TokenSearchValue component1, StringSearchValue component2), Schema.Model.V4.TokenStringCompositeSearchParamTableTypeRow>
    {
        ...
        internal override bool TryGenerateRow(short searchParamId, (TokenSearchValue component1, StringSearchValue component2) searchValue, out Schema.Model.V4.TokenStringCompositeSearchParamTableTypeRow row)
        {
            ...
            {
                row = new Schema.Model.V4.TokenStringCompositeSearchParamTableTypeRow(
                    searchParamId,
                    token1Row.SystemId,
                    token1Row.Code,
                    string2Row.Text,
