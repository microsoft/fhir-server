...
{
    internal class TokenQuantityCompositeSearchParameterRowGenerator : CompositeSearchParameterRowGenerator<(TokenSearchValue component1, QuantitySearchValue component2), Schema.Model.V4.TokenQuantityCompositeSearchParamTableTypeRow>
    {
        ...
        internal override bool TryGenerateRow(short searchParamId, (TokenSearchValue component1, QuantitySearchValue component2) searchValue, out Schema.Model.V4.TokenQuantityCompositeSearchParamTableTypeRow row)
        {
            ...
            {
                row = new Schema.Model.V4.TokenQuantityCompositeSearchParamTableTypeRow(
                    searchParamId,
                    token1Row.SystemId,
                    token1Row.Code,
                    token2Row.SystemId,
