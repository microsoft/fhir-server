...
{
    internal class QuantitySearchParameterV1RowGenerator : SearchParameterRowGenerator<QuantitySearchValue, QuantitySearchParamTableTypeV1Row>
    {
        public QuantitySearchParameterV1RowGenerator(SqlServerFhirModel model)
            : base(model)
        {
        }

        internal override bool TryGenerateRow(short searchParamId, QuantitySearchValue searchValue, out QuantitySearchParamTableTypeV1Row row)
        {
            bool isSingleValue = searchValue.Low == searchValue.High;

            row = new QuantitySearchParamTableTypeV1Row(
                searchParamId,
