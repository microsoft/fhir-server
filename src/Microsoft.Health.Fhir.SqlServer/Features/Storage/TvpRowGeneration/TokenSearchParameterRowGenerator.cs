...
namespace Microsoft.Health.Fhir.SqlServer.Features.Storage.TvpRowGeneration
{
    internal class TokenSearchParameterRowGenerator : SearchParameterRowGenerator<TokenSearchValue, V1.TokenSearchParamTableTypeRow>
    {
        ...
        protected override bool ShouldGenerateRow(SearchParameterInfo searchParameter, TokenSearchValue searchValue) => !string.IsNullOrWhiteSpace(searchValue.Code);

        protected override V1.TokenSearchParamTableTypeRow GenerateRow(short searchParamId, SearchParameterInfo searchParameter, TokenSearchValue searchValue)
        {
