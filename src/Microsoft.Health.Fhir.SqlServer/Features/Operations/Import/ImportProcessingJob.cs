    ...
    public class ImportProcessingJob : IJob
    {
        ...
        public async Task<string> ExecuteAsync(JobInfo jobInfo, IProgress<string> progress, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                {
                    _logger.LogInformation(ex, "Import processing operation is failed.");
                    var error = new ImportProcessingJobErrorResult() { Message = "Import processing operation is failed." };
