...
namespace Microsoft.Health.Fhir.SqlServer.Features.Storage
{
    public class SqlImportOperation : ISqlImportOperation, IImportOrchestratorTaskDataStoreOperation
    {
        ...
        public static IReadOnlyList<(Table table, Index index)> OptionalIndexesForImport { get; } =
            new List<(Table table, Index index)>()
            {
                (VLatest.Resource, VLatest.Resource.UQIX_Resource_ResourceSurrogateId),
                ...
                (VLatest.ReferenceTokenCompositeSearchParam, VLatest.ReferenceTokenCompositeSearchParam.UQIX_ReferenceTokenCompositeSearchParam_ReferenceResourceId1_Code2),
