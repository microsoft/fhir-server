...
namespace Microsoft.Health.Fhir.SqlServer.Features.Schema
{
    ...
    {
        public const int Min = (int)SchemaVersion.V78;
        public const int Max = (int)SchemaVersion.V78;
        public const int MinForUpgrade = (int)SchemaVersion.V78; // this is used for upgrade tests only
