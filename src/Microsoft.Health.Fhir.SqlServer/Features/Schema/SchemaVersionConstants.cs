...
namespace Microsoft.Health.Fhir.SqlServer.Features.Schema
{
    ...
    {
        public const int Min = (int)SchemaVersion.V64;
        public const int Max = (int)SchemaVersion.V69;
        public const int MinForUpgrade = (int)SchemaVersion.V64; // this is used for upgrade tests only
