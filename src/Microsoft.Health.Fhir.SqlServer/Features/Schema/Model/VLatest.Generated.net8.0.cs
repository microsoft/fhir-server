...
namespace Microsoft.Health.Fhir.SqlServer.Features.Schema.Model
{
    ...
    internal class VLatest
    {
        ...
        internal readonly static CreateResourceSearchParamStatsProcedure CreateResourceSearchParamStats = new CreateResourceSearchParamStatsProcedure();
        ...
        internal readonly static GetResourceSearchParamStatsProcedure GetResourceSearchParamStats = new GetResourceSearchParamStatsProcedure();
        ...
        internal class CreateResourceSearchParamStatsProcedure : StoredProcedure
        {
            internal CreateResourceSearchParamStatsProcedure() : base("dbo.CreateResourceSearchParamStats")
            {
            }

            private readonly ParameterDefinition<System.String> _Table = new ParameterDefinition<System.String>("@Table", global::System.Data.SqlDbType.VarChar, false, 100);
            private readonly ParameterDefinition<System.String> _Column = new ParameterDefinition<System.String>("@Column", global::System.Data.SqlDbType.VarChar, false, 100);
            private readonly ParameterDefinition<System.Int16> _ResourceTypeId = new ParameterDefinition<System.Int16>("@ResourceTypeId", global::System.Data.SqlDbType.SmallInt, false);
            private readonly ParameterDefinition<System.Int16> _SearchParamId = new ParameterDefinition<System.Int16>("@SearchParamId", global::System.Data.SqlDbType.SmallInt, false);

            public void PopulateCommand(SqlCommandWrapper command, System.String Table, System.String Column, System.Int16 ResourceTypeId, System.Int16 SearchParamId)
            {
                command.CommandType = global::System.Data.CommandType.StoredProcedure;
                command.CommandText = "dbo.CreateResourceSearchParamStats";
                _Table.AddParameter(command.Parameters, Table);
                _Column.AddParameter(command.Parameters, Column);
                _ResourceTypeId.AddParameter(command.Parameters, ResourceTypeId);
                _SearchParamId.AddParameter(command.Parameters, SearchParamId);
            }
        }
        ...
        internal class GetResourceSearchParamStatsProcedure : StoredProcedure
        {
            internal GetResourceSearchParamStatsProcedure() : base("dbo.GetResourceSearchParamStats")
            {
            }

            private readonly ParameterDefinition<System.String> _Table = new ParameterDefinition<System.String>("@Table", global::System.Data.SqlDbType.VarChar, true, 100);
            private readonly ParameterDefinition<System.Nullable<System.Int16>> _ResourceTypeId = new ParameterDefinition<System.Nullable<System.Int16>>("@ResourceTypeId", global::System.Data.SqlDbType.SmallInt, true);
            private readonly ParameterDefinition<System.Nullable<System.Int16>> _SearchParamId = new ParameterDefinition<System.Nullable<System.Int16>>("@SearchParamId", global::System.Data.SqlDbType.SmallInt, true);

            public void PopulateCommand(SqlCommandWrapper command, System.String Table, System.Nullable<System.Int16> ResourceTypeId, System.Nullable<System.Int16> SearchParamId)
            {
                command.CommandType = global::System.Data.CommandType.StoredProcedure;
                command.CommandText = "dbo.GetResourceSearchParamStats";
                _Table.AddParameter(command.Parameters, Table);
                _ResourceTypeId.AddParameter(command.Parameters, ResourceTypeId);
                _SearchParamId.AddParameter(command.Parameters, SearchParamId);
            }
