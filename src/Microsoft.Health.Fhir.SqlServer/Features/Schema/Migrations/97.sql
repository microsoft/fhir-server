...
CREATE TYPE dbo.ResourceList AS TABLE (
    ...
    PartitionId          SMALLINT        NULL PRIMARY KEY (ResourceTypeId, ResourceSurrogateId),
...
CREATE TABLE dbo.JobQueue (
    ...
    LogicalPartitionId SMALLINT       CONSTRAINT DF_JobQueue_LogicalPartitionId DEFAULT 2 NOT NULL,
...
CREATE TABLE dbo.CurrentResource (
    ...
    IsRawResourceMetaSet BIT             NOT NULL,
    SearchParamHash      VARCHAR (64)    NULL,
    PartitionId          SMALLINT        DEFAULT 2 NOT NULL,
        ...
        BEGIN
            ...
            IF @@rowcount > 0
                BEGIN
                    ...
                    SET @AffectedRows += @@rowcount;
                END
            INSERT INTO dbo.Resource (ResourceTypeId, ResourceId, Version, IsHistory, ResourceSurrogateId, IsDeleted, RequestMethod, RawResource, IsRawResourceMetaSet, SearchParamHash, TransactionId, PartitionId)
            SELECT ResourceTypeId,
                   ResourceId,
                   Version,
                   IsHistory,
