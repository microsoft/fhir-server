...
ALTER TABLE dbo.ReferenceSearchParam
    ADD CONSTRAINT CH_ReferenceSearchParam_IsHistory CHECK (IsHistory = 0);
...
ALTER TABLE dbo.ReferenceSearchParam
    ADD CONSTRAINT PK_ReferenceSearchParam_ReferenceResourceId_ReferenceResourceTypeId_SearchParamId_BaseUri_ResourceSurrogateId_ResourceTypeId PRIMARY KEY NONCLUSTERED (ReferenceResourceId, ReferenceResourceTypeId, SearchParamId, BaseUri, ResourceSurrogateId, ResourceTypeId) WITH (DATA_COMPRESSION = PAGE, ONLINE = ON) ON PartitionScheme_ResourceTypeId (ResourceTypeId);
