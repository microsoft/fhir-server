...
CREATE TYPE dbo.ReferenceSearchParamList AS TABLE (
    ...
    ReferenceResourceId      VARCHAR (64)  COLLATE Latin1_General_100_CS_AS NOT NULL UNIQUE (ResourceTypeId, ResourceSurrogateId, SearchParamId, BaseUri, ReferenceResourceTypeId, ReferenceResourceId));
...
CREATE TYPE dbo.ResourceKeyList AS TABLE (
    ResourceTypeId SMALLINT     NOT NULL,
    ResourceId     VARCHAR (64) COLLATE Latin1_General_100_CS_AS NOT NULL,
    Version        BIGINT          NULL UNIQUE (ResourceTypeId, ResourceId, Version));
...
BEGIN TRY
    ...
    IF @IsRetry = 0
        BEGIN
            ...
            SET @AffectedRows += @@rowcount;
            INSERT INTO dbo.ReferenceSearchParam (ResourceTypeId, ResourceSurrogateId, SearchParamId, BaseUri, ReferenceResourceTypeId, ReferenceResourceId)
            SELECT ResourceTypeId,
                   ResourceSurrogateId,
                   SearchParamId,
                   BaseUri,
            ...
            SET @AffectedRows += @@rowcount;
            INSERT INTO dbo.ReferenceTokenCompositeSearchParam (ResourceTypeId, ResourceSurrogateId, SearchParamId, BaseUri1, ReferenceResourceTypeId1, ReferenceResourceId1, SystemId2, Code2, CodeOverflow2)
            SELECT ResourceTypeId,
                   ResourceSurrogateId,
                   SearchParamId,
                   BaseUri1,
