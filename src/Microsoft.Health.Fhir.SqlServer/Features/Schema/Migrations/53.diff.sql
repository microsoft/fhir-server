CREATE OR ALTER PROCEDURE dbo.DeleteSearchParameterReferences -- Used to quickly process Pending Delete and Pending Disable searchparameters before the normal reindex process.
