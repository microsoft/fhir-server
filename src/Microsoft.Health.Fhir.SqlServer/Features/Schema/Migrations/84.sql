...
CREATE PARTITION FUNCTION PartitionFunction_ResourceTypeId(TINYINT)
    AS RANGE RIGHT
...
CREATE TYPE dbo.ReferenceTokenCompositeSearchParamList AS TABLE (
    ...
    ReferenceResourceTypeId1  TINYINT       NULL,
...
AS
SET NOCOUNT ON;
DECLARE @st AS DATETIME = getUTCdate(), @SP AS VARCHAR (100) = object_name(@@procid), @DummyTop AS BIGINT = 9223372036854775807, @InitialTranCount AS INT = @@trancount, @IsRetry AS BIT = 0, @RT AS TINYINT, @NewIdsCount AS INT, @FirstIdInt AS BIGINT;
...
BEGIN TRY
    DECLARE @RTs AS TABLE (
        ResourceTypeId TINYINT NOT NULL PRIMARY KEY);
    ...
    WHILE EXISTS (SELECT *
        ...
        BEGIN
            ...
            WHERE  ResourceTypeId = @RT;
        END
    INSERT INTO @ResourcesWithIds (ResourceTypeId, ResourceIdInt, Version, HasVersionToCompare, IsHistory, ResourceSurrogateId, IsDeleted, RequestMethod, KeepHistory, RawResource, IsRawResourceMetaSet, SearchParamHash, OffsetInFile)
    SELECT A.ResourceTypeId,
           isnull(C.ResourceIdInt, B.ResourceIdInt),
           Version,
           HasVersionToCompare,
        ...
        BEGIN
            ...
            IF @@rowcount > 0
                BEGIN
                    ...
                    SET @AffectedRows += @@rowcount;
                END
            INSERT INTO dbo.Resource (ResourceTypeId, ResourceIdInt, Version, IsHistory, ResourceSurrogateId, IsDeleted, RequestMethod, RawResource, IsRawResourceMetaSet, SearchParamHash, TransactionId, OffsetInFile)
            SELECT ResourceTypeId,
                   ResourceIdInt,
                   Version,
                   IsHistory,
...
GO
CREATE TRIGGER dbo.ReferenceSearchParamDel
...
CREATE TRIGGER dbo.ResourceIns
    ...
    AS BEGIN
           ...
           INSERT INTO dbo.CurrentResources (ResourceTypeId, ResourceSurrogateId, ResourceIdInt, Version, IsDeleted, RequestMethod, IsRawResourceMetaSet, SearchParamHash, TransactionId, HistoryTransactionId, OffsetInFile)
           SELECT ResourceTypeId,
                  ResourceSurrogateId,
                  ResourceIdInt,
                  Version,
