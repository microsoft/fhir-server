...
BEGIN TRY
    ...
    SELECT ResourceTypeId,
           ...
           ReferenceResourceVersion
    FROM   @ReferenceSearchParams;
    INSERT INTO dbo.IdentitySearchParam (ResourceTypeId, ResourceSurrogateId, SearchParamId, SystemId, Code, CodeOverflow)
    SELECT ResourceTypeId,
           ResourceSurrogateId,
           SearchParamId,
           SystemId,
