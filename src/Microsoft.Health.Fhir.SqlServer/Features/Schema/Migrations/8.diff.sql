/*************************************************************
    Migration 8: Adds Version and Fragment columns
    to UriSearchParam to support Canonical searches
**************************************************************/

BEGIN TRANSACTION

CREATE TYPE dbo.UriSearchParamTableType_2 AS TABLE
(
...
CREATE PROCEDURE dbo.UpsertResource_3
    ...
    @uriSearchParams dbo.UriSearchParamTableType_2 READONLY,
...
AS
    ...
    INSERT INTO dbo.UriSearchParam
        (ResourceTypeId, ResourceSurrogateId, SearchParamId, Uri, Version, Fragment, IsHistory)
    SELECT DISTINCT @resourceTypeId, @resourceSurrogateId, SearchParamId, Uri, Version, Fragment, 0
