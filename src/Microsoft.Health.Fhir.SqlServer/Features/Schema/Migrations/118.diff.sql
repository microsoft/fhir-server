...
IF NOT EXISTS
    ...
    THROW 50419, 'Schema version 118 requires native vector type support. Use Azure SQL Database or SQL Server 2025 or later.', 1
GO
...
BEGIN
    ...
    (
        ...
        UNIQUE (ResourceTypeId, ResourceSurrogateId, SearchParamId, EmbeddingModelId, ChunkOrdinal)
    )
END
GO
