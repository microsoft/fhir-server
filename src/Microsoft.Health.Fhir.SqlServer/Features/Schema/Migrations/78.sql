...
CREATE INDEX IX_SearchParamId_StartDateTime_EndDateTime_INCLUDE_IsMin_IsMax_WHERE_IsLongerThanADay_1
    ON dbo.DateTimeSearchParam(SearchParamId, StartDateTime, EndDateTime) WHERE IsLongerThanADay = 1
    ON PartitionScheme_ResourceTypeId (ResourceTypeId);

CREATE INDEX IX_SearchParamId_EndDateTime_StartDateTime_INCLUDE_IsMin_IsMax_WHERE_IsLongerThanADay_1
    ON dbo.DateTimeSearchParam(SearchParamId, EndDateTime, StartDateTime) WHERE IsLongerThanADay = 1
    ON PartitionScheme_ResourceTypeId (ResourceTypeId);
...
CREATE COLUMNSTORE INDEX IX_SearchParamId_QuantityCodeId_SingleValue_INCLUDE_SystemId_WHERE_SingleValue_NOT_NULL
    ON dbo.QuantitySearchParam(SearchParamId, QuantityCodeId, SingleValue) WHERE SingleValue IS NOT NULL
    ON PartitionScheme_ResourceTypeId (ResourceTypeId);
...
CREATE COLUMNSTORE INDEX IXU_ReferenceResourceId_ReferenceResourceTypeId_SearchParamId_BaseUri_ResourceSurrogateId_ResourceTypeId
    ON dbo.ReferenceSearchParam(ReferenceResourceId, ReferenceResourceTypeId, SearchParamId, BaseUri, ResourceSurrogateId, ResourceTypeId)
    ON PartitionScheme_ResourceTypeId (ResourceTypeId);
...
CREATE INDEX IX_SearchParamId_Text_INCLUDE_IsMin_IsMax_WHERE_TextOverflow_NOT_NULL
    ON dbo.StringSearchParam(SearchParamId, Text) WHERE TextOverflow IS NOT NULL
    ON PartitionScheme_ResourceTypeId (ResourceTypeId);
...
CREATE INDEX IX_SearchParamId_Code1_StartDateTime2_EndDateTime2_INCLUDE_SystemId1_WHERE_IsLongerThanADay2_1
    ON dbo.TokenDateTimeCompositeSearchParam(SearchParamId, Code1, StartDateTime2, EndDateTime2) WHERE IsLongerThanADay2 = 1
    ON PartitionScheme_ResourceTypeId (ResourceTypeId);

CREATE INDEX IX_SearchParamId_Code1_EndDateTime2_StartDateTime2_INCLUDE_SystemId1_WHERE_IsLongerThanADay2_1
    ON dbo.TokenDateTimeCompositeSearchParam(SearchParamId, Code1, EndDateTime2, StartDateTime2) WHERE IsLongerThanADay2 = 1
    ON PartitionScheme_ResourceTypeId (ResourceTypeId);
...
CREATE COLUMNSTORE INDEX IX_SearchParamId_Code1_SingleValue2_SingleValue3_INCLUDE_SystemId1_WHERE_HasRange_0
    ON dbo.TokenNumberNumberCompositeSearchParam(SearchParamId, Code1, SingleValue2, SingleValue3) WHERE HasRange = 0
    ON PartitionScheme_ResourceTypeId (ResourceTypeId);

CREATE INDEX IX_SearchParamId_Code1_LowValue2_HighValue2_LowValue3_HighValue3_INCLUDE_SystemId1_WHERE_HasRange_1
    ON dbo.TokenNumberNumberCompositeSearchParam(SearchParamId, Code1, LowValue2, HighValue2, LowValue3, HighValue3) WHERE HasRange = 1
    ON PartitionScheme_ResourceTypeId (ResourceTypeId);
...
CREATE COLUMNSTORE INDEX IX_SearchParamId_Code1_SingleValue2_INCLUDE_QuantityCodeId2_SystemId1_SystemId2_WHERE_SingleValue2_NOT_NULL
    ON dbo.TokenQuantityCompositeSearchParam(SearchParamId, Code1, SingleValue2) WHERE SingleValue2 IS NOT NULL
    ON PartitionScheme_ResourceTypeId (ResourceTypeId);
...
CREATE INDEX IX_SearchParamId_Code1_LowValue2_HighValue2_INCLUDE_QuantityCodeId2_SystemId1_SystemId2_WHERE_LowValue2_NOT_NULL
    ON dbo.TokenQuantityCompositeSearchParam(SearchParamId, Code1, LowValue2, HighValue2) WHERE LowValue2 IS NOT NULL
    ON PartitionScheme_ResourceTypeId (ResourceTypeId);
...
CREATE INDEX IX_SearchParamId_Code1_HighValue2_LowValue2_INCLUDE_QuantityCodeId2_SystemId1_SystemId2_WHERE_LowValue2_NOT_NULL
    ON dbo.TokenQuantityCompositeSearchParam(SearchParamId, Code1, HighValue2, LowValue2) WHERE LowValue2 IS NOT NULL
    ON PartitionScheme_ResourceTypeId (ResourceTypeId);
...
CREATE COLUMNSTORE INDEX IX_SearchParamId_Code_INCLUDE_SystemId
...
CREATE INDEX IX_SearchParamId_Code1_Text2_INCLUDE_SystemId1_WHERE_TextOverflow2_NOT_NULL
    ON dbo.TokenStringCompositeSearchParam(SearchParamId, Code1, Text2) WHERE TextOverflow2 IS NOT NULL
    ON PartitionScheme_ResourceTypeId (ResourceTypeId);
...
CREATE COLUMNSTORE INDEX IX_TokenText_SearchParamId_Text
    ON dbo.TokenText(SearchParamId, Text, ResourceSurrogateId) WHERE IsHistory = 0
    ON PartitionScheme_ResourceTypeId (ResourceTypeId);
...
CREATE COLUMNSTORE INDEX IX_SearchParamId_Uri
    ON dbo.UriSearchParam(SearchParamId, Uri)
    ON PartitionScheme_ResourceTypeId (ResourceTypeId);
...
@ResourceTypeId SMALLINT, @StartId BIGINT, @EndId BIGINT, @GlobalStartId BIGINT=NULL, @GlobalEndId BIGINT=NULL, @IncludeHistory BIT=0, @IncludeDeleted BIT=0
AS
SET NOCOUNT ON;
