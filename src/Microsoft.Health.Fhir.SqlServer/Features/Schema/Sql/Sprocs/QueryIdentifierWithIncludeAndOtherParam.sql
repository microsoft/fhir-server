...
--
-- STORED PROCEDURE
--     QueryIdentifierWithIncludeAndOtherParam
--
-- DESCRIPTION
--     Runs a particular search query where we are searching for a chained resource by identifier
--     and we are including another resource in the search,
--     and we are searching for a resource by a parameter that is not the identifier.
--
GO
