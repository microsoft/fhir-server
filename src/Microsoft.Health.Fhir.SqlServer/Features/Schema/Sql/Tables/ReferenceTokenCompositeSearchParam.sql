...
ALTER TABLE dbo.ReferenceTokenCompositeSearchParam ADD CONSTRAINT CHK_ReferenceTokenCompositeSearchParam_CodeOverflow2 CHECK (DATALENGTH(Code2) = 256 OR CodeOverflow2 IS NULL)
