...
ALTER TABLE dbo.TokenTokenCompositeSearchParam ADD CONSTRAINT CHK_TokenTokenCompositeSearchParam_CodeOverflow1 CHECK (DATALENGTH(Code1) = 256 OR CodeOverflow1 IS NULL)

ALTER TABLE dbo.TokenTokenCompositeSearchParam ADD CONSTRAINT CHK_TokenTokenCompositeSearchParam_CodeOverflow2 CHECK (DATALENGTH(Code2) = 256 OR CodeOverflow2 IS NULL)
