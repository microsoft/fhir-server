...
WHERE c.ChunkRank <= @MaxChunksPerResource
ORDER BY s.BestDistance, s.ResourceSurrogateId, c.ChunkRank;";
            ...
            CancellationToken cancellationToken)
        {
            ...
            EnsureArg.IsGt(maxChunksPerResource, 0, nameof(maxChunksPerResource));
            ...
            command.Parameters.Add("@MaxChunksPerResource", SqlDbType.Int).Value = maxChunksPerResource;
