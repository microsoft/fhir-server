...
{
    public class TokenTokenCompositeSearchParamGenerator : ISearchParamGenerator
    {
        private ModelProvider _modelProvider;

        public TokenTokenCompositeSearchParamGenerator(ModelProvider modelProvider)
        {
        ...
        public DataRow GenerateDataRow(DataTable table, BulkCopySearchParamWrapper searchParam)
        {
            ...
            var token1 = (TokenSearchValue)content[0][0];
            var token2 = (TokenSearchValue)content[0][1];
            ...
            row["IsHistory"] = false;
            TokenSearchParamGenerator.FillInRow(row, token1, "1");
            TokenSearchParamGenerator.FillInRow(row, token2, "2");
