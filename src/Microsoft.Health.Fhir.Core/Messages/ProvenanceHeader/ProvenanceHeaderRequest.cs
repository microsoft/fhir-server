...
{
    public class ProvenanceHeaderRequest : IRequest<RawResourceElement>, IRequest
    {
        public ProvenanceHeaderRequest(ResourceElement target, string provenanceHeader)
        {
