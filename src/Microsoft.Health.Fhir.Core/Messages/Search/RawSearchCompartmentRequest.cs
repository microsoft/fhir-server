...
{
    public class RawSearchCompartmentRequest : IRequest<RawSearchCompartmentResponse>
    {
        public RawSearchCompartmentRequest(string compartmentType, string compartmentId, string resourceType, IReadOnlyList<Tuple<string, string>> queries)
        {
