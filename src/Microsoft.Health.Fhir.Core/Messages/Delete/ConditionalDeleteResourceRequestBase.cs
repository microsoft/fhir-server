...
public abstract class ConditionalDeleteResourceRequestBase<TResponse> : ConditionalResourceRequest<TResponse>, IRequireCapability
{
    private static readonly string[] Capabilities = new string[2] { "conditionalDelete.exists()", "conditionalDelete != 'not-supported'" };

    protected ConditionalDeleteResourceRequestBase(
        string resourceType,
