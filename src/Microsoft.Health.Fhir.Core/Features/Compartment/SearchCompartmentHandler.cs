...
namespace Microsoft.Health.Fhir.Core.Features.Search
{
    ...
    public class SearchCompartmentHandler : IRequestHandler<SearchCompartmentRequest, SearchCompartmentResponse>
    {
        ...
        public SearchCompartmentHandler(ISearchService searchService, IBundleFactory bundleFactory, IAuthorizationService<DataActions> authorizationService, ISearchResultFilter searchResultFilter)
        {
