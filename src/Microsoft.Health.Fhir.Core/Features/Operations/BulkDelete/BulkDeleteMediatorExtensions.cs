...
namespace Microsoft.Health.Fhir.Core.Features.Operations.BulkDelete
{
    ...
    {
        public static async Task<CreateBulkDeleteResponse> BulkDeleteAsync(this IMediator mediator, DeleteOperation deleteOperation, string resourceType, IList<Tuple<string, string>> searchParameters, bool includeSoftDeleted, bool removeReferences, CancellationToken cancellationToken)
        {
            EnsureArg.IsNotNull(mediator, nameof(mediator));

            var request = new CreateBulkDeleteRequest(deleteOperation, resourceType, searchParameters, includeSoftDeleted, removeReferences);
