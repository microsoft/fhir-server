...
namespace Microsoft.Health.Fhir.Core.Features.Operations.BulkUpdate.Handlers
{
    public class CreateBulkUpdateHandler : IRequestHandler<CreateBulkUpdateRequest, CreateBulkUpdateResponse>
    {
        ...
        public async Task<CreateBulkUpdateResponse> HandleAsync(CreateBulkUpdateRequest request, CancellationToken cancellationToken)
        {
            ...
            SmartFineGrainedAccessControlRejection.EnsureAllowed(_coreFeatures.EnableSmartBulkDeleteAndUpdateRestriction, _contextAccessor, "$bulk-update job creation");
