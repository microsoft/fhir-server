...
namespace Microsoft.Health.Fhir.Core.Features.Operations.Security
{
    ...
    internal static class SmartFineGrainedAccessControlGuard
    {
        ...
        /// </summary>
        /// <param name="restrictionEnabled">Whether the operation-specific SMART restriction is enabled.</param>
        ...
        internal static void EnsureAllowed(bool restrictionEnabled, RequestContextAccessor<IFhirRequestContext> requestContextAccessor, string operationName)
        {
