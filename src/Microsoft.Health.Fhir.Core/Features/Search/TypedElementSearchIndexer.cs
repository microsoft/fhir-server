...
namespace Microsoft.Health.Fhir.Core.Features.Search
{
    ...
    public class TypedElementSearchIndexer : ISearchIndexer
    {
        ...
        private readonly ITypedElementToSearchValueTypeConverterManager _fhirElementTypeConverterManager;
        ...
        public TypedElementSearchIndexer(
            ...
            ITypedElementToSearchValueTypeConverterManager fhirElementTypeConverterManager,
            ...
            EvaluationContext context)
        {
            ...
            {
                if (!_fhirElementTypeConverterManager.TryGetConverter(extractedValue.InstanceType, GetSearchValueTypeForSearchParamType(searchParameterType), out ITypedElementToSearchValueTypeConverter converter))
                {
                    _logger.LogWarning(
