...
{
    /// <summary>
    /// Resolves FHIR SearchParameters configured for vector indexing and querying.
    /// </summary>
    public interface IVectorSearchParameterResolver
    {
        /// <summary>
        /// Gets vector SearchParameters applicable to a FHIR resource type.
        /// </summary>
        ...
        /// <summary>
        /// Gets vector SearchParameters eligible for indexing a FHIR resource type, including supported definitions awaiting activation.
        /// </summary>
        /// <param name="resourceType">The FHIR resource type.</param>
        /// <returns>The applicable vector SearchParameters.</returns>
        IReadOnlyList<SearchParameterInfo> GetIndexingSearchParameters(string resourceType);

        /// <summary>
        /// Gets and validates a vector SearchParameter by canonical URI.
        /// </summary>
