...
namespace Microsoft.Health.Fhir.Core.Features.Search.Converters
{
    ...
    /// </summary>
    public class CanonicalToUriSearchValueTypeConverter : FhirTypedElementToSearchValueTypeConverter<UriSearchValue>
    {
        public CanonicalToUriSearchValueTypeConverter()
            : base("canonical")
        {
        }
