...
namespace Microsoft.Health.Fhir.Core.Features.Search.Converters
{
    ...
    /// </summary>
    public class PeriodToDateTimeSearchValueTypeConverter : FhirTypedElementToSearchValueTypeConverter<DateTimeSearchValue>
    {
        public PeriodToDateTimeSearchValueTypeConverter()
            : base("Period")
        {
        }
