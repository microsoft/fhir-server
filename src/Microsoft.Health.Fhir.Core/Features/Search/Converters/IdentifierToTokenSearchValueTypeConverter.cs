...
namespace Microsoft.Health.Fhir.Core.Features.Search.Converters
{
    ...
    /// </summary>
    public class IdentifierToTokenSearchValueTypeConverter : FhirTypedElementToSearchValueTypeConverter<TokenSearchValue>
    {
        public IdentifierToTokenSearchValueTypeConverter()
            : base("Identifier")
        {
        }
