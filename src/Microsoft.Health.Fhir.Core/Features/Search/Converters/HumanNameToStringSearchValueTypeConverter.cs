...
namespace Microsoft.Health.Fhir.Core.Features.Search.Converters
{
    ...
    /// </summary>
    public class HumanNameToStringSearchValueTypeConverter : FhirTypedElementToSearchValueTypeConverter<StringSearchValue>
    {
        public HumanNameToStringSearchValueTypeConverter()
            : base("HumanName")
        {
        }
