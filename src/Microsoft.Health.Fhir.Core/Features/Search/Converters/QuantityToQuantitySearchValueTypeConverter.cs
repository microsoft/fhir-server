...
namespace Microsoft.Health.Fhir.Core.Features.Search.Converters
{
    ...
    /// </summary>
    public class QuantityToQuantitySearchValueTypeConverter : FhirTypedElementToSearchValueTypeConverter<QuantitySearchValue>
    {
        public QuantityToQuantitySearchValueTypeConverter()
            : base("Quantity")
        {
        }
