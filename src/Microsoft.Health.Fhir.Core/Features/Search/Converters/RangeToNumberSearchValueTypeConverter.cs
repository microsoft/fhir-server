...
namespace Microsoft.Health.Fhir.Core.Features.Search.Converters
{
    ...
    /// </summary>
    public class RangeToNumberSearchValueTypeConverter : FhirTypedElementToSearchValueTypeConverter<NumberSearchValue>
    {
        public RangeToNumberSearchValueTypeConverter()
            : base("Range")
        {
        }
