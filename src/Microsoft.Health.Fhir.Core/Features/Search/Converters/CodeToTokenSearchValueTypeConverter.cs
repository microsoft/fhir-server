...
namespace Microsoft.Health.Fhir.Core.Features.Search.Converters
{
    ...
    /// </summary>
    public class CodeToTokenSearchValueTypeConverter : FhirTypedElementToSearchValueTypeConverter<TokenSearchValue>
    {
        private readonly ICodeSystemResolver _codeSystemResolver;

        public CodeToTokenSearchValueTypeConverter(ICodeSystemResolver codeSystemResolver)
            : base("code", "codeOfT")
        {
