...
{
    public abstract class FhirTypedElementToSearchValueTypeConverter<T> : ITypedElementToSearchValueTypeConverter
    {
        protected FhirTypedElementToSearchValueTypeConverter(params string[] fhirTypes)
        {
