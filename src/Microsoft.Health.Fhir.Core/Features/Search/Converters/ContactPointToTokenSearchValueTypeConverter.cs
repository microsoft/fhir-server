...
namespace Microsoft.Health.Fhir.Core.Features.Search.Converters
{
    ...
    /// </summary>
    public class ContactPointToTokenSearchValueTypeConverter : FhirTypedElementToSearchValueTypeConverter<TokenSearchValue>
    {
        public ContactPointToTokenSearchValueTypeConverter()
            : base("ContactPoint")
        {
        }
