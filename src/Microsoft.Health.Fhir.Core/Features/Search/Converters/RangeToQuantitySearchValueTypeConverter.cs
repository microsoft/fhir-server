...
namespace Microsoft.Health.Fhir.Core.Features.Search.Converters
{
    ...
    /// </summary>
    public class RangeToQuantitySearchValueTypeConverter : FhirTypedElementToSearchValueTypeConverter<QuantitySearchValue>
    {
        public RangeToQuantitySearchValueTypeConverter()
            : base("Range")
        {
        }
