...
namespace Microsoft.Health.Fhir.Core.Features.Search.Converters
{
    ...
    /// </summary>
    public class InstantToDateTimeSearchValueTypeConverter : FhirTypedElementToSearchValueTypeConverter<DateTimeSearchValue>
    {
        public InstantToDateTimeSearchValueTypeConverter()
            : base("instant")
        {
        }
