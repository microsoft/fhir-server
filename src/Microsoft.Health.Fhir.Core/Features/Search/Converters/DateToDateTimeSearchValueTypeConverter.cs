...
namespace Microsoft.Health.Fhir.Core.Features.Search.Converters
{
    ...
    /// </summary>
    public class DateToDateTimeSearchValueTypeConverter : FhirTypedElementToSearchValueTypeConverter<DateTimeSearchValue>
    {
        public DateToDateTimeSearchValueTypeConverter()
            : base("date", "dateTime")
        {
        }
