...
namespace Microsoft.Health.Fhir.Core.Features.Search.Converters
{
    ...
    /// </summary>
    public class CodingToTokenSearchValueTypeConverter : FhirTypedElementToSearchValueTypeConverter<TokenSearchValue>
    {
        public CodingToTokenSearchValueTypeConverter()
            : base("Coding")
        {
        }
