...
namespace Microsoft.Health.Fhir.Core.Features.Search.Converters
{
    ...
    /// </summary>
    public class BooleanToTokenSearchValueTypeConverter : FhirTypedElementToSearchValueTypeConverter<TokenSearchValue>
    {
        public BooleanToTokenSearchValueTypeConverter()
            : base("boolean")
        {
        }
