...
{
    /// <summary>
    /// A converter used to convert from <see cref="Code{T}"/> to a list of <see cref="ISearchValue"/>.
    /// </summary>
    public class CodeOfTToSearchValueTypeConverter : IFhirElementToSearchValueTypeConverter
    {
