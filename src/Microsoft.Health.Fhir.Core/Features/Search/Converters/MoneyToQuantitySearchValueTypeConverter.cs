...
namespace Microsoft.Health.Fhir.Core.Features.Search.Converters
{
    ...
    /// </summary>
    public class MoneyToQuantitySearchValueTypeConverter : FhirTypedElementToSearchValueTypeConverter<QuantitySearchValue>
    {
        public MoneyToQuantitySearchValueTypeConverter()
            : base("Money")
        {
        }
