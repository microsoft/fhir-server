...
namespace Microsoft.Health.Fhir.Core.Features.Search.Converters
{
    ...
    /// </summary>
    public class IntegerToNumberSearchValueTypeConverter : FhirTypedElementToSearchValueTypeConverter<NumberSearchValue>
    {
        public IntegerToNumberSearchValueTypeConverter()
