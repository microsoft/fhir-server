...
namespace Microsoft.Health.Fhir.Core.Features.Search.Converters
{
    ...
    /// </summary>
    public interface IFhirNodeToSearchValueTypeConverterManager
    {
        /// <summary>
        ...
        bool TryGetConverter(string fhirElementType, Type searchValueType, out IFhirNodeToSearchValueTypeConverter converter);
    }
}
