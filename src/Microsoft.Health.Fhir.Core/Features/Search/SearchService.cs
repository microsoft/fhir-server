...
namespace Microsoft.Health.Fhir.Core.Features.Search
{
    ...
    public abstract class SearchService : ISearchService
    {
        ...
        {
            SearchOptions searchOptions = await _searchOptionsFactory.Create(resourceType, queryParameters, isAsyncOperation, resourceVersionTypes, cancellationToken);
            ...
            bool isAsyncOperation = false)
        {
            ...
            SearchOptions searchOptions = await _searchOptionsFactory.Create(resourceType, queryParameters, isAsyncOperation, historyResourceVersionTypes, cancellationToken);
