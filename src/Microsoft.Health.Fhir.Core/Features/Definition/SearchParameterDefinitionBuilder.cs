...
namespace Microsoft.Health.Fhir.Core.Features.Definition
{
    internal static class SearchParameterDefinitionBuilder
    {
        ...
        internal static SearchParameterInfo GetOrCreateSearchParameterInfo(SearchParameterWrapper searchParameter, IDictionary<Uri, SearchParameterInfo> uriDictionary = null)
        {
            // Return SearchParameterInfo that has already been created for this Uri
            if (uriDictionary != null && uriDictionary.TryGetValue(new Uri(searchParameter.Url), out var spi))
            {
                return spi;
            }
