...
namespace Microsoft.Health.Fhir.Core.Features.Persistence
{
    ...
    {
        Task<IDictionary<ResourceKey, DataStoreOperationOutcome>> MergeAsync(IReadOnlyList<ResourceWrapperOperation> resources, CancellationToken cancellationToken);
